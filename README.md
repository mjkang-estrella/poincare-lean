...
- `Poincare/CompletionTarget.lean` records the canonical completion theorem name,
  ...
  and certified extraction-derivation canonical/project payload projections now
  name the same ordinary forgetful endpoints. The dependency-projection layer
