...
if [ "$canonical_statement_payload_bridge_count" != "16" ]; then
  echo "FAIL: canonical statement and packaged smooth bridges should consume the shared Poincare-completion bridge"
