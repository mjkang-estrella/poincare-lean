...
check_decl "project smooth statement exposes reverse canonical smooth statement bridge is declared" \
  '^theorem reverse_canonical_smooth_three_sphere_statement_of_smooth_statement\b' Poincare/Assembly.lean
check_decl "reverse canonical smooth statement to project smooth statement bridge is declared" \
  '^theorem smooth_statement_of_reverse_canonical_smooth_three_sphere_statement\b' Poincare/Assembly.lean
check_decl "reverse canonical smooth statement to forward canonical smooth statement bridge is declared" \
  '^theorem canonical_smooth_three_sphere_statement_of_reverse_canonical_smooth_three_sphere_statement\b' Poincare/Assembly.lean
check_decl "reverse canonical smooth statement to project smooth statement equivalence is declared" \
  '^theorem reverse_canonical_smooth_three_sphere_statement_iff_smooth_statement\b' Poincare/Assembly.lean
check_decl "forward canonical smooth statement to reverse canonical smooth statement equivalence is declared" \
  '^theorem canonical_smooth_three_sphere_statement_iff_reverse_canonical_smooth_three_sphere_statement\b' Poincare/Assembly.lean
...
check_decl "project smooth reverse canonical-statement equality contract is declared" \
  '^theorem reverse_canonical_smooth_three_sphere_statement_of_smooth_statement_eq\b' Poincare/Assembly.lean
check_decl "reverse canonical smooth project-statement equality contract is declared" \
  '^theorem smooth_statement_of_reverse_canonical_smooth_three_sphere_statement_eq\b' Poincare/Assembly.lean
check_decl "reverse canonical smooth forward-statement equality contract is declared" \
  '^theorem canonical_smooth_three_sphere_statement_of_reverse_canonical_smooth_three_sphere_statement_eq\b' Poincare/Assembly.lean
check_decl "reverse canonical smooth project-smooth iff equality contract is declared" \
  '^theorem reverse_canonical_smooth_three_sphere_statement_iff_smooth_statement_eq\b' Poincare/Assembly.lean
check_decl "forward/reverse canonical smooth iff equality contract is declared" \
  '^theorem canonical_smooth_three_sphere_statement_iff_reverse_canonical_smooth_three_sphere_statement_eq\b' Poincare/Assembly.lean
...
check_decl "remaining dependency plus canonical statement statement roundtrip contract is declared" \
  '^theorem canonical_three_sphere_statement_of_completion_certificate_of_remaining_dependency_and_canonical_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependencies plus canonical statement dependency roundtrip contract is declared" \
  '^theorem poincareProofDependencies_of_completion_certificate_of_poincareProofDependencies_and_canonical_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependencies plus canonical statement statement roundtrip contract is declared" \
  '^theorem canonical_three_sphere_statement_of_completion_certificate_of_poincareProofDependencies_and_canonical_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "remaining dependency canonical statement certificate target projection roundtrip contract is declared" \
  '^theorem target_statement_of_completion_certificate_of_remaining_dependency_and_canonical_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "remaining dependency canonical statement certificate project payload projection roundtrip contract is declared" \
  '^theorem poincare_completion_payload_of_completion_certificate_of_remaining_dependency_and_canonical_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "remaining dependency canonical statement certificate canonical payload projection roundtrip contract is declared" \
  '^theorem canonical_completion_payload_of_completion_certificate_of_remaining_dependency_and_canonical_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "remaining dependency canonical statement certificate canonical target projection roundtrip contract is declared" \
  '^theorem canonical_completion_target_of_completion_certificate_of_remaining_dependency_and_canonical_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "remaining dependency canonical statement certificate criterion projection roundtrip contract is declared" \
  '^theorem completion_criterion_of_completion_certificate_of_remaining_dependency_and_canonical_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency canonical statement certificate target projection roundtrip contract is declared" \
  '^theorem target_statement_of_completion_certificate_of_poincareProofDependencies_and_canonical_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency canonical statement certificate project payload projection roundtrip contract is declared" \
  '^theorem poincare_completion_payload_of_completion_certificate_of_poincareProofDependencies_and_canonical_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency canonical statement certificate canonical payload projection roundtrip contract is declared" \
  '^theorem canonical_completion_payload_of_completion_certificate_of_poincareProofDependencies_and_canonical_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency canonical statement certificate canonical target projection roundtrip contract is declared" \
  '^theorem canonical_completion_target_of_completion_certificate_of_poincareProofDependencies_and_canonical_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency canonical statement certificate criterion projection roundtrip contract is declared" \
...
check_decl "canonical payload bridge from reverse smooth statement is declared" \
  '^theorem canonical_completion_payload_of_reverse_canonical_smooth_three_sphere_statement\b' Poincare/CanonicalBridges.lean
check_decl "canonical target bridge from reverse smooth statement is declared" \
  '^theorem canonical_completion_target_of_reverse_canonical_smooth_three_sphere_statement\b' Poincare/CanonicalBridges.lean
check_decl "canonical criterion bridge from reverse smooth statement is declared" \
  '^theorem canonical_completion_criterion_of_reverse_canonical_smooth_three_sphere_statement\b' Poincare/CanonicalBridges.lean
...
check_decl "remaining dependency plus reverse canonical smooth statement certificate constructor is declared" \
  '^theorem completion_certificate_of_remaining_dependency_and_reverse_canonical_smooth_three_sphere_statement\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependencies plus reverse canonical smooth statement certificate constructor is declared" \
  '^theorem completion_certificate_of_poincareProofDependencies_and_reverse_canonical_smooth_three_sphere_statement\b' Poincare/CanonicalBridges.lean
...
check_decl "remaining dependency packaged reverse canonical smooth route completion payload is declared" \
  '^theorem packaged_reverse_canonical_smooth_three_sphere_statement_completion_payload_of_remaining_dependency\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency packaged reverse canonical smooth route completion payload is declared" \
  '^theorem packaged_reverse_canonical_smooth_three_sphere_statement_completion_payload_of_poincareProofDependencies\b' Poincare/CanonicalBridges.lean
...
check_decl "remaining dependency packaged smooth statement certificate iff equality contract is declared" \
  '^theorem poincareCompletionCertificate_iff_remainingDependencyPackage_and_packaged_smooth_statement_payload_eq\b' Poincare/CanonicalBridges.lean
...
check_decl "aggregate dependency packaged smooth statement certificate iff equality contract is declared" \
  '^theorem poincareCompletionCertificate_iff_poincareProofDependencies_and_packaged_smooth_statement_payload_eq\b' Poincare/CanonicalBridges.lean
...
check_decl "remaining dependency packaged canonical smooth statement certificate iff equality contract is declared" \
  '^theorem poincareCompletionCertificate_iff_remainingDependencyPackage_and_packaged_canonical_smooth_three_sphere_statement_payload_eq\b' Poincare/CanonicalBridges.lean
...
check_decl "aggregate dependency packaged canonical smooth statement certificate iff equality contract is declared" \
  '^theorem poincareCompletionCertificate_iff_poincareProofDependencies_and_packaged_canonical_smooth_three_sphere_statement_payload_eq\b' Poincare/CanonicalBridges.lean
check_decl "remaining dependency packaged smooth payload constructor projection roundtrip is declared" \
  '^theorem poincareCompletionCertificate_remainingDependencyPackage_packaged_smooth_statement_payload_of_completion_certificate_of_remaining_dependency_package_packaged_smooth_statement_payload_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency packaged smooth payload constructor projection roundtrip is declared" \
  '^theorem poincareCompletionCertificate_poincareProofDependencies_packaged_smooth_statement_payload_of_completion_certificate_of_poincareProofDependencies_packaged_smooth_statement_payload_eq\b' Poincare/CanonicalBridges.lean
check_decl "remaining dependency packaged canonical smooth payload constructor projection roundtrip is declared" \
  '^theorem poincareCompletionCertificate_remainingDependencyPackage_packaged_canonical_smooth_three_sphere_statement_payload_of_completion_certificate_of_remaining_dependency_package_packaged_canonical_smooth_three_sphere_statement_payload_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency packaged canonical smooth payload constructor projection roundtrip is declared" \
  '^theorem poincareCompletionCertificate_poincareProofDependencies_packaged_canonical_smooth_three_sphere_statement_payload_of_completion_certificate_of_poincareProofDependencies_packaged_canonical_smooth_three_sphere_statement_payload_eq\b' Poincare/CanonicalBridges.lean
...
check_decl "reverse canonical smooth statement payload equality contract is declared" \
  '^theorem canonical_completion_payload_of_reverse_canonical_smooth_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "reverse canonical smooth statement target equality contract is declared" \
  '^theorem canonical_completion_target_of_reverse_canonical_smooth_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "reverse canonical smooth statement criterion equality contract is declared" \
  '^theorem canonical_completion_criterion_of_reverse_canonical_smooth_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
...
check_decl "remaining dependency reverse canonical smooth statement certificate equality contract is declared" \
  '^theorem completion_certificate_of_remaining_dependency_and_reverse_canonical_smooth_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency reverse canonical smooth statement certificate equality contract is declared" \
...
check_decl "remaining dependency smooth statement certificate projection roundtrip contract is declared" \
  '^theorem remaining_dependency_package_of_completion_certificate_of_remaining_dependency_and_smooth_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency smooth statement certificate projection roundtrip contract is declared" \
  '^theorem poincareProofDependencies_of_completion_certificate_of_poincareProofDependencies_and_smooth_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "remaining dependency canonical smooth statement certificate projection roundtrip contract is declared" \
  '^theorem remaining_dependency_package_of_completion_certificate_of_remaining_dependency_and_canonical_smooth_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency canonical smooth statement certificate projection roundtrip contract is declared" \
  '^theorem poincareProofDependencies_of_completion_certificate_of_poincareProofDependencies_and_canonical_smooth_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
...
check_decl "remaining dependency packaged reverse canonical smooth payload equality contract is declared" \
  '^theorem packaged_reverse_canonical_smooth_three_sphere_statement_completion_payload_of_remaining_dependency_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency packaged reverse canonical smooth payload equality contract is declared" \
  '^theorem packaged_reverse_canonical_smooth_three_sphere_statement_completion_payload_of_poincareProofDependencies_eq\b' Poincare/CanonicalBridges.lean
...
check_decl "packaged smooth aggregate/remaining payload equivalence equality contract is declared" \
  '^theorem packaged_smooth_statement_payload_iff_poincareProofDependencies_remainingDependencyPackage_eq\b' Poincare/CanonicalBridges.lean
...
check_decl "packaged canonical smooth aggregate/remaining payload equivalence equality contract is declared" \
  '^theorem packaged_canonical_smooth_three_sphere_statement_payload_iff_poincareProofDependencies_remainingDependencyPackage_eq\b' Poincare/CanonicalBridges.lean
...
check_decl "remaining dependency packaged reverse canonical smooth target projection is declared" \
  '^theorem poincare_statement_of_remaining_dependency_and_packaged_reverse_canonical_smooth_three_sphere_statement\b' Poincare/CanonicalBridges.lean
check_decl "remaining dependency packaged reverse canonical smooth project criterion projection is declared" \
  '^theorem completion_criterion_of_remaining_dependency_and_packaged_reverse_canonical_smooth_three_sphere_statement\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency packaged reverse canonical smooth target projection is declared" \
  '^theorem poincare_statement_of_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency packaged reverse canonical smooth project criterion projection is declared" \
  '^theorem completion_criterion_of_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement\b' Poincare/CanonicalBridges.lean
check_decl "remaining dependency packaged reverse canonical smooth project payload is declared" \
  '^theorem poincare_completion_payload_of_remaining_dependency_and_packaged_reverse_canonical_smooth_three_sphere_statement\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency packaged reverse canonical smooth project payload is declared" \
  '^theorem poincare_completion_payload_of_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement\b' Poincare/CanonicalBridges.lean
check_decl "remaining dependency packaged reverse canonical smooth canonical payload is declared" \
  '^theorem canonical_completion_payload_of_remaining_dependency_and_packaged_reverse_canonical_smooth_three_sphere_statement\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency packaged reverse canonical smooth canonical payload is declared" \
  '^theorem canonical_completion_payload_of_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement\b' Poincare/CanonicalBridges.lean
check_decl "remaining dependency packaged reverse canonical smooth canonical target is declared" \
  '^theorem canonical_completion_target_of_remaining_dependency_and_packaged_reverse_canonical_smooth_three_sphere_statement\b' Poincare/CanonicalBridges.lean
check_decl "remaining dependency packaged reverse canonical smooth canonical criterion is declared" \
  '^theorem canonical_completion_criterion_of_remaining_dependency_and_packaged_reverse_canonical_smooth_three_sphere_statement\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency packaged reverse canonical smooth canonical target is declared" \
  '^theorem canonical_completion_target_of_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency packaged reverse canonical smooth canonical criterion is declared" \
  '^theorem canonical_completion_criterion_of_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement\b' Poincare/CanonicalBridges.lean
check_decl "remaining dependency packaged reverse canonical smooth canonical statement is declared" \
  '^theorem canonical_three_sphere_statement_of_remaining_dependency_and_packaged_reverse_canonical_smooth_three_sphere_statement\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency packaged reverse canonical smooth canonical statement is declared" \
  '^theorem canonical_three_sphere_statement_of_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement\b' Poincare/CanonicalBridges.lean
check_decl "remaining dependency packaged reverse canonical smooth certificate constructor is declared" \
  '^theorem completion_certificate_of_remaining_dependency_and_packaged_reverse_canonical_smooth_three_sphere_statement\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency packaged reverse canonical smooth certificate constructor is declared" \
  '^theorem completion_certificate_of_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement\b' Poincare/CanonicalBridges.lean
check_decl "remaining dependency packaged reverse canonical smooth target equality contract is declared" \
  '^theorem poincare_statement_of_remaining_dependency_and_packaged_reverse_canonical_smooth_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "remaining dependency packaged reverse canonical smooth criterion equality contract is declared" \
  '^theorem completion_criterion_of_remaining_dependency_and_packaged_reverse_canonical_smooth_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency packaged reverse canonical smooth target equality contract is declared" \
  '^theorem poincare_statement_of_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency packaged reverse canonical smooth criterion equality contract is declared" \
  '^theorem completion_criterion_of_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "remaining dependency packaged reverse canonical smooth project payload equality contract is declared" \
  '^theorem poincare_completion_payload_of_remaining_dependency_and_packaged_reverse_canonical_smooth_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency packaged reverse canonical smooth project payload equality contract is declared" \
  '^theorem poincare_completion_payload_of_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "remaining dependency packaged reverse canonical smooth canonical payload equality contract is declared" \
  '^theorem canonical_completion_payload_of_remaining_dependency_and_packaged_reverse_canonical_smooth_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency packaged reverse canonical smooth canonical payload equality contract is declared" \
  '^theorem canonical_completion_payload_of_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "remaining dependency packaged reverse canonical smooth canonical target equality contract is declared" \
  '^theorem canonical_completion_target_of_remaining_dependency_and_packaged_reverse_canonical_smooth_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "remaining dependency packaged reverse canonical smooth canonical criterion equality contract is declared" \
  '^theorem canonical_completion_criterion_of_remaining_dependency_and_packaged_reverse_canonical_smooth_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "remaining dependency packaged reverse canonical smooth canonical statement equality contract is declared" \
  '^theorem canonical_three_sphere_statement_of_remaining_dependency_and_packaged_reverse_canonical_smooth_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency packaged reverse canonical smooth canonical target equality contract is declared" \
  '^theorem canonical_completion_target_of_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency packaged reverse canonical smooth canonical criterion equality contract is declared" \
  '^theorem canonical_completion_criterion_of_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency packaged reverse canonical smooth canonical statement equality contract is declared" \
  '^theorem canonical_three_sphere_statement_of_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency packaged reverse canonical smooth target remaining-dependency equality contract is declared" \
  '^theorem poincare_statement_of_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement_to_remaining_dependency_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency packaged reverse canonical smooth criterion remaining-dependency equality contract is declared" \
  '^theorem completion_criterion_of_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement_to_remaining_dependency_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency packaged reverse canonical smooth project payload remaining-dependency equality contract is declared" \
  '^theorem poincare_completion_payload_of_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement_to_remaining_dependency_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency packaged reverse canonical smooth canonical payload remaining-dependency equality contract is declared" \
  '^theorem canonical_completion_payload_of_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement_to_remaining_dependency_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency packaged reverse canonical smooth canonical target remaining-dependency equality contract is declared" \
  '^theorem canonical_completion_target_of_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement_to_remaining_dependency_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency packaged reverse canonical smooth canonical criterion remaining-dependency equality contract is declared" \
  '^theorem canonical_completion_criterion_of_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement_to_remaining_dependency_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency packaged reverse canonical smooth canonical statement remaining-dependency equality contract is declared" \
  '^theorem canonical_three_sphere_statement_of_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement_to_remaining_dependency_eq\b' Poincare/CanonicalBridges.lean
check_decl "remaining dependency packaged reverse canonical smooth certificate equality contract is declared" \
  '^theorem completion_certificate_of_remaining_dependency_and_packaged_reverse_canonical_smooth_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency packaged reverse canonical smooth certificate remaining-dependency equality contract is declared" \
  '^theorem completion_certificate_of_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement_to_remaining_dependency_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency packaged reverse canonical smooth certificate equality contract is declared" \
  '^theorem completion_certificate_of_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "remaining dependency packaged reverse canonical smooth certificate dependency projection roundtrip is declared" \
  '^theorem remaining_dependency_package_of_completion_certificate_of_remaining_dependency_and_packaged_reverse_canonical_smooth_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency packaged reverse canonical smooth certificate dependency projection roundtrip is declared" \
  '^theorem poincareProofDependencies_of_completion_certificate_of_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "remaining dependency packaged reverse canonical smooth certificate canonical statement projection roundtrip is declared" \
  '^theorem canonical_three_sphere_statement_of_completion_certificate_of_remaining_dependency_and_packaged_reverse_canonical_smooth_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency packaged reverse canonical smooth certificate canonical statement projection roundtrip is declared" \
  '^theorem canonical_three_sphere_statement_of_completion_certificate_of_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "remaining dependency packaged reverse canonical smooth certificate canonical target projection roundtrip is declared" \
  '^theorem canonical_completion_target_of_completion_certificate_of_remaining_dependency_and_packaged_reverse_canonical_smooth_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "remaining dependency packaged reverse canonical smooth certificate criterion projection roundtrip is declared" \
  '^theorem completion_criterion_of_completion_certificate_of_remaining_dependency_and_packaged_reverse_canonical_smooth_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency packaged reverse canonical smooth certificate canonical target projection roundtrip is declared" \
  '^theorem canonical_completion_target_of_completion_certificate_of_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency packaged reverse canonical smooth certificate criterion projection roundtrip is declared" \
  '^theorem completion_criterion_of_completion_certificate_of_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "remaining dependency packaged reverse canonical smooth certificate project payload projection roundtrip is declared" \
  '^theorem poincare_completion_payload_of_completion_certificate_of_remaining_dependency_and_packaged_reverse_canonical_smooth_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "remaining dependency packaged reverse canonical smooth certificate canonical payload projection roundtrip is declared" \
  '^theorem canonical_completion_payload_of_completion_certificate_of_remaining_dependency_and_packaged_reverse_canonical_smooth_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency packaged reverse canonical smooth certificate project payload projection roundtrip is declared" \
  '^theorem poincare_completion_payload_of_completion_certificate_of_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency packaged reverse canonical smooth certificate canonical payload projection roundtrip is declared" \
  '^theorem canonical_completion_payload_of_completion_certificate_of_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "remaining dependency packaged reverse canonical smooth certificate target projection roundtrip is declared" \
  '^theorem target_statement_of_completion_certificate_of_remaining_dependency_and_packaged_reverse_canonical_smooth_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency packaged reverse canonical smooth certificate target projection roundtrip is declared" \
...
check_decl "aggregate dependency packaged reverse canonical smooth payload certificate constructor is declared" \
  '^theorem completion_certificate_of_poincareProofDependencies_packaged_reverse_canonical_smooth_three_sphere_statement_payload\b' Poincare/CanonicalBridges.lean
check_decl "remaining dependency packaged reverse canonical smooth payload certificate iff is declared" \
  '^theorem poincareCompletionCertificate_iff_remainingDependencyPackage_and_packaged_reverse_canonical_smooth_three_sphere_statement_payload\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency packaged reverse canonical smooth payload certificate iff is declared" \
  '^theorem poincareCompletionCertificate_iff_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement_payload\b' Poincare/CanonicalBridges.lean
check_decl "remaining dependency packaged reverse canonical smooth payload certificate iff equality contract is declared" \
  '^theorem poincareCompletionCertificate_iff_remainingDependencyPackage_and_packaged_reverse_canonical_smooth_three_sphere_statement_payload_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency packaged reverse canonical smooth payload certificate iff equality contract is declared" \
  '^theorem poincareCompletionCertificate_iff_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement_payload_eq\b' Poincare/CanonicalBridges.lean
check_decl "remaining dependency packaged reverse canonical smooth payload projection-after-constructor is declared" \
  '^theorem poincareCompletionCertificate_remainingDependencyPackage_packaged_reverse_canonical_smooth_three_sphere_statement_payload_of_completion_certificate_of_remaining_dependency_package_packaged_reverse_canonical_smooth_three_sphere_statement_payload_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency packaged reverse canonical smooth payload projection-after-constructor is declared" \
  '^theorem poincareCompletionCertificate_poincareProofDependencies_packaged_reverse_canonical_smooth_three_sphere_statement_payload_of_completion_certificate_of_poincareProofDependencies_packaged_reverse_canonical_smooth_three_sphere_statement_payload_eq\b' Poincare/CanonicalBridges.lean
check_decl "packaged reverse canonical smooth aggregate remaining payload equivalence is declared" \
  '^theorem packaged_reverse_canonical_smooth_three_sphere_statement_payload_iff_poincareProofDependencies_remainingDependencyPackage\b' Poincare/CanonicalBridges.lean
check_decl "packaged reverse canonical smooth aggregate remaining payload equivalence equality contract is declared" \
  '^theorem packaged_reverse_canonical_smooth_three_sphere_statement_payload_iff_poincareProofDependencies_remainingDependencyPackage_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate packaged reverse canonical smooth certificate iff remaining-dependency equality contract is declared" \
  '^theorem poincareCompletionCertificate_iff_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement_payload_to_remaining_dependency_eq\b' Poincare/CanonicalBridges.lean
...
check_decl "standalone smoothability package reverse canonical smooth route completion payload is declared" \
  '^theorem smoothability_package_reverse_canonical_smooth_three_sphere_statement_completion_payload\b' Poincare/CanonicalBridges.lean
check_decl "standalone smoothability package reverse canonical smooth route target is declared" \
  '^theorem poincare_statement_of_smoothability_package_and_reverse_canonical_smooth_three_sphere_statement\b' Poincare/CanonicalBridges.lean
check_decl "standalone smoothability package reverse canonical smooth route criterion is declared" \
  '^theorem completion_criterion_of_smoothability_package_and_reverse_canonical_smooth_three_sphere_statement\b' Poincare/CanonicalBridges.lean
check_decl "standalone smoothability package reverse canonical smooth route project payload is declared" \
  '^theorem poincare_completion_payload_of_smoothability_package_and_reverse_canonical_smooth_three_sphere_statement\b' Poincare/CanonicalBridges.lean
check_decl "standalone smoothability package reverse canonical smooth route canonical payload is declared" \
  '^theorem canonical_completion_payload_of_smoothability_package_and_reverse_canonical_smooth_three_sphere_statement\b' Poincare/CanonicalBridges.lean
check_decl "standalone smoothability package reverse canonical smooth route canonical target is declared" \
  '^theorem canonical_completion_target_of_smoothability_package_and_reverse_canonical_smooth_three_sphere_statement\b' Poincare/CanonicalBridges.lean
check_decl "standalone smoothability package reverse canonical smooth route canonical criterion is declared" \
  '^theorem canonical_completion_criterion_of_smoothability_package_and_reverse_canonical_smooth_three_sphere_statement\b' Poincare/CanonicalBridges.lean
check_decl "standalone smoothability package reverse canonical smooth route canonical statement is declared" \
  '^theorem canonical_three_sphere_statement_of_smoothability_package_and_reverse_canonical_smooth_three_sphere_statement\b' Poincare/CanonicalBridges.lean
check_decl "standalone smoothability package reverse canonical smooth route completion payload equality contract is declared" \
  '^theorem smoothability_package_reverse_canonical_smooth_three_sphere_statement_completion_payload_eq\b' Poincare/CanonicalBridges.lean
check_decl "standalone smoothability package reverse canonical smooth route target equality contract is declared" \
  '^theorem poincare_statement_of_smoothability_package_and_reverse_canonical_smooth_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "standalone smoothability package reverse canonical smooth route criterion equality contract is declared" \
  '^theorem completion_criterion_of_smoothability_package_and_reverse_canonical_smooth_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "standalone smoothability package reverse canonical smooth route project payload equality contract is declared" \
  '^theorem poincare_completion_payload_of_smoothability_package_and_reverse_canonical_smooth_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "standalone smoothability package reverse canonical smooth route canonical payload equality contract is declared" \
  '^theorem canonical_completion_payload_of_smoothability_package_and_reverse_canonical_smooth_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "standalone smoothability package reverse canonical smooth route canonical target equality contract is declared" \
  '^theorem canonical_completion_target_of_smoothability_package_and_reverse_canonical_smooth_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "standalone smoothability package reverse canonical smooth route canonical criterion equality contract is declared" \
  '^theorem canonical_completion_criterion_of_smoothability_package_and_reverse_canonical_smooth_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "standalone smoothability package reverse canonical smooth route canonical statement equality contract is declared" \
  '^theorem canonical_three_sphere_statement_of_smoothability_package_and_reverse_canonical_smooth_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
...
check_decl "remaining dependency packaged reverse canonical smooth payload standalone smoothability equality contract is declared" \
  '^theorem packaged_reverse_canonical_smooth_three_sphere_statement_completion_payload_of_remaining_dependency_to_smoothability_package_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency packaged reverse canonical smooth payload standalone smoothability equality contract is declared" \
  '^theorem packaged_reverse_canonical_smooth_three_sphere_statement_completion_payload_of_poincareProofDependencies_to_smoothability_package_eq\b' Poincare/CanonicalBridges.lean
check_decl "remaining dependency packaged reverse canonical smooth target standalone smoothability equality contract is declared" \
  '^theorem poincare_statement_of_remaining_dependency_and_packaged_reverse_canonical_smooth_three_sphere_statement_to_smoothability_package_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency packaged reverse canonical smooth target standalone smoothability equality contract is declared" \
  '^theorem poincare_statement_of_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement_to_smoothability_package_eq\b' Poincare/CanonicalBridges.lean
check_decl "remaining dependency packaged reverse canonical smooth criterion standalone smoothability equality contract is declared" \
  '^theorem completion_criterion_of_remaining_dependency_and_packaged_reverse_canonical_smooth_three_sphere_statement_to_smoothability_package_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency packaged reverse canonical smooth criterion standalone smoothability equality contract is declared" \
  '^theorem completion_criterion_of_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement_to_smoothability_package_eq\b' Poincare/CanonicalBridges.lean
check_decl "remaining dependency packaged reverse canonical smooth project payload standalone smoothability equality contract is declared" \
  '^theorem poincare_completion_payload_of_remaining_dependency_and_packaged_reverse_canonical_smooth_three_sphere_statement_to_smoothability_package_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency packaged reverse canonical smooth project payload standalone smoothability equality contract is declared" \
  '^theorem poincare_completion_payload_of_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement_to_smoothability_package_eq\b' Poincare/CanonicalBridges.lean
check_decl "remaining dependency packaged reverse canonical smooth canonical payload standalone smoothability equality contract is declared" \
  '^theorem canonical_completion_payload_of_remaining_dependency_and_packaged_reverse_canonical_smooth_three_sphere_statement_to_smoothability_package_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency packaged reverse canonical smooth canonical payload standalone smoothability equality contract is declared" \
  '^theorem canonical_completion_payload_of_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement_to_smoothability_package_eq\b' Poincare/CanonicalBridges.lean
check_decl "remaining dependency packaged reverse canonical smooth canonical target standalone smoothability equality contract is declared" \
  '^theorem canonical_completion_target_of_remaining_dependency_and_packaged_reverse_canonical_smooth_three_sphere_statement_to_smoothability_package_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency packaged reverse canonical smooth canonical target standalone smoothability equality contract is declared" \
  '^theorem canonical_completion_target_of_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement_to_smoothability_package_eq\b' Poincare/CanonicalBridges.lean
check_decl "remaining dependency packaged reverse canonical smooth canonical criterion standalone smoothability equality contract is declared" \
  '^theorem canonical_completion_criterion_of_remaining_dependency_and_packaged_reverse_canonical_smooth_three_sphere_statement_to_smoothability_package_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency packaged reverse canonical smooth canonical criterion standalone smoothability equality contract is declared" \
  '^theorem canonical_completion_criterion_of_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement_to_smoothability_package_eq\b' Poincare/CanonicalBridges.lean
check_decl "remaining dependency packaged reverse canonical smooth canonical statement standalone smoothability equality contract is declared" \
  '^theorem canonical_three_sphere_statement_of_remaining_dependency_and_packaged_reverse_canonical_smooth_three_sphere_statement_to_smoothability_package_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency packaged reverse canonical smooth canonical statement standalone smoothability equality contract is declared" \
  '^theorem canonical_three_sphere_statement_of_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement_to_smoothability_package_eq\b' Poincare/CanonicalBridges.lean
check_decl "remaining dependency packaged reverse canonical smooth certificate standalone smoothability equality contract is declared" \
  '^theorem completion_certificate_of_remaining_dependency_and_packaged_reverse_canonical_smooth_three_sphere_statement_to_smoothability_package_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency packaged reverse canonical smooth certificate standalone smoothability equality contract is declared" \
  '^theorem completion_certificate_of_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement_to_smoothability_package_eq\b' Poincare/CanonicalBridges.lean
check_decl "remaining dependency packaged smooth certificate projection roundtrip contract is declared" \
  '^theorem remaining_dependency_package_of_completion_certificate_of_remaining_dependency_and_packaged_smooth_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency packaged smooth certificate projection roundtrip contract is declared" \
  '^theorem poincareProofDependencies_of_completion_certificate_of_poincareProofDependencies_and_packaged_smooth_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "remaining dependency packaged canonical smooth certificate projection roundtrip contract is declared" \
  '^theorem remaining_dependency_package_of_completion_certificate_of_remaining_dependency_and_packaged_canonical_smooth_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency packaged canonical smooth certificate projection roundtrip contract is declared" \
  '^theorem poincareProofDependencies_of_completion_certificate_of_poincareProofDependencies_and_packaged_canonical_smooth_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "remaining dependency smooth statement certificate canonical statement projection roundtrip contract is declared" \
  '^theorem canonical_three_sphere_statement_of_completion_certificate_of_remaining_dependency_and_smooth_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency smooth statement certificate canonical statement projection roundtrip contract is declared" \
  '^theorem canonical_three_sphere_statement_of_completion_certificate_of_poincareProofDependencies_and_smooth_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "remaining dependency canonical smooth statement certificate canonical statement projection roundtrip contract is declared" \
  '^theorem canonical_three_sphere_statement_of_completion_certificate_of_remaining_dependency_and_canonical_smooth_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency canonical smooth statement certificate canonical statement projection roundtrip contract is declared" \
  '^theorem canonical_three_sphere_statement_of_completion_certificate_of_poincareProofDependencies_and_canonical_smooth_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "remaining dependency packaged smooth certificate canonical statement projection roundtrip contract is declared" \
  '^theorem canonical_three_sphere_statement_of_completion_certificate_of_remaining_dependency_and_packaged_smooth_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency packaged smooth certificate canonical statement projection roundtrip contract is declared" \
  '^theorem canonical_three_sphere_statement_of_completion_certificate_of_poincareProofDependencies_and_packaged_smooth_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "remaining dependency packaged canonical smooth certificate canonical statement projection roundtrip contract is declared" \
  '^theorem canonical_three_sphere_statement_of_completion_certificate_of_remaining_dependency_and_packaged_canonical_smooth_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency packaged canonical smooth certificate canonical statement projection roundtrip contract is declared" \
  '^theorem canonical_three_sphere_statement_of_completion_certificate_of_poincareProofDependencies_and_packaged_canonical_smooth_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "remaining dependency smooth statement certificate canonical target projection roundtrip contract is declared" \
  '^theorem canonical_completion_target_of_completion_certificate_of_remaining_dependency_and_smooth_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "remaining dependency smooth statement certificate criterion projection roundtrip contract is declared" \
  '^theorem completion_criterion_of_completion_certificate_of_remaining_dependency_and_smooth_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency smooth statement certificate canonical target projection roundtrip contract is declared" \
  '^theorem canonical_completion_target_of_completion_certificate_of_poincareProofDependencies_and_smooth_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency smooth statement certificate criterion projection roundtrip contract is declared" \
  '^theorem completion_criterion_of_completion_certificate_of_poincareProofDependencies_and_smooth_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "remaining dependency canonical smooth statement certificate canonical target projection roundtrip contract is declared" \
  '^theorem canonical_completion_target_of_completion_certificate_of_remaining_dependency_and_canonical_smooth_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "remaining dependency canonical smooth statement certificate criterion projection roundtrip contract is declared" \
  '^theorem completion_criterion_of_completion_certificate_of_remaining_dependency_and_canonical_smooth_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency canonical smooth statement certificate canonical target projection roundtrip contract is declared" \
  '^theorem canonical_completion_target_of_completion_certificate_of_poincareProofDependencies_and_canonical_smooth_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency canonical smooth statement certificate criterion projection roundtrip contract is declared" \
  '^theorem completion_criterion_of_completion_certificate_of_poincareProofDependencies_and_canonical_smooth_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "remaining dependency packaged smooth certificate canonical target projection roundtrip contract is declared" \
  '^theorem canonical_completion_target_of_completion_certificate_of_remaining_dependency_and_packaged_smooth_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "remaining dependency packaged smooth certificate criterion projection roundtrip contract is declared" \
  '^theorem completion_criterion_of_completion_certificate_of_remaining_dependency_and_packaged_smooth_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency packaged smooth certificate canonical target projection roundtrip contract is declared" \
  '^theorem canonical_completion_target_of_completion_certificate_of_poincareProofDependencies_and_packaged_smooth_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency packaged smooth certificate criterion projection roundtrip contract is declared" \
  '^theorem completion_criterion_of_completion_certificate_of_poincareProofDependencies_and_packaged_smooth_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "remaining dependency packaged canonical smooth certificate canonical target projection roundtrip contract is declared" \
  '^theorem canonical_completion_target_of_completion_certificate_of_remaining_dependency_and_packaged_canonical_smooth_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "remaining dependency packaged canonical smooth certificate criterion projection roundtrip contract is declared" \
  '^theorem completion_criterion_of_completion_certificate_of_remaining_dependency_and_packaged_canonical_smooth_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency packaged canonical smooth certificate canonical target projection roundtrip contract is declared" \
  '^theorem canonical_completion_target_of_completion_certificate_of_poincareProofDependencies_and_packaged_canonical_smooth_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency packaged canonical smooth certificate criterion projection roundtrip contract is declared" \
  '^theorem completion_criterion_of_completion_certificate_of_poincareProofDependencies_and_packaged_canonical_smooth_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "remaining dependency smooth statement certificate project payload projection roundtrip contract is declared" \
  '^theorem poincare_completion_payload_of_completion_certificate_of_remaining_dependency_and_smooth_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "remaining dependency smooth statement certificate canonical payload projection roundtrip contract is declared" \
  '^theorem canonical_completion_payload_of_completion_certificate_of_remaining_dependency_and_smooth_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency smooth statement certificate project payload projection roundtrip contract is declared" \
  '^theorem poincare_completion_payload_of_completion_certificate_of_poincareProofDependencies_and_smooth_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency smooth statement certificate canonical payload projection roundtrip contract is declared" \
  '^theorem canonical_completion_payload_of_completion_certificate_of_poincareProofDependencies_and_smooth_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "remaining dependency canonical smooth statement certificate project payload projection roundtrip contract is declared" \
  '^theorem poincare_completion_payload_of_completion_certificate_of_remaining_dependency_and_canonical_smooth_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "remaining dependency canonical smooth statement certificate canonical payload projection roundtrip contract is declared" \
  '^theorem canonical_completion_payload_of_completion_certificate_of_remaining_dependency_and_canonical_smooth_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency canonical smooth statement certificate project payload projection roundtrip contract is declared" \
  '^theorem poincare_completion_payload_of_completion_certificate_of_poincareProofDependencies_and_canonical_smooth_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency canonical smooth statement certificate canonical payload projection roundtrip contract is declared" \
  '^theorem canonical_completion_payload_of_completion_certificate_of_poincareProofDependencies_and_canonical_smooth_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "remaining dependency packaged smooth certificate project payload projection roundtrip contract is declared" \
  '^theorem poincare_completion_payload_of_completion_certificate_of_remaining_dependency_and_packaged_smooth_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "remaining dependency packaged smooth certificate canonical payload projection roundtrip contract is declared" \
  '^theorem canonical_completion_payload_of_completion_certificate_of_remaining_dependency_and_packaged_smooth_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency packaged smooth certificate project payload projection roundtrip contract is declared" \
  '^theorem poincare_completion_payload_of_completion_certificate_of_poincareProofDependencies_and_packaged_smooth_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency packaged smooth certificate canonical payload projection roundtrip contract is declared" \
  '^theorem canonical_completion_payload_of_completion_certificate_of_poincareProofDependencies_and_packaged_smooth_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "remaining dependency packaged canonical smooth certificate project payload projection roundtrip contract is declared" \
  '^theorem poincare_completion_payload_of_completion_certificate_of_remaining_dependency_and_packaged_canonical_smooth_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "remaining dependency packaged canonical smooth certificate canonical payload projection roundtrip contract is declared" \
  '^theorem canonical_completion_payload_of_completion_certificate_of_remaining_dependency_and_packaged_canonical_smooth_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency packaged canonical smooth certificate project payload projection roundtrip contract is declared" \
  '^theorem poincare_completion_payload_of_completion_certificate_of_poincareProofDependencies_and_packaged_canonical_smooth_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency packaged canonical smooth certificate canonical payload projection roundtrip contract is declared" \
  '^theorem canonical_completion_payload_of_completion_certificate_of_poincareProofDependencies_and_packaged_canonical_smooth_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "remaining dependency smooth statement certificate target projection roundtrip contract is declared" \
  '^theorem target_statement_of_completion_certificate_of_remaining_dependency_and_smooth_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency smooth statement certificate target projection roundtrip contract is declared" \
  '^theorem target_statement_of_completion_certificate_of_poincareProofDependencies_and_smooth_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "remaining dependency canonical smooth statement certificate target projection roundtrip contract is declared" \
  '^theorem target_statement_of_completion_certificate_of_remaining_dependency_and_canonical_smooth_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency canonical smooth statement certificate target projection roundtrip contract is declared" \
  '^theorem target_statement_of_completion_certificate_of_poincareProofDependencies_and_canonical_smooth_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "remaining dependency packaged smooth certificate target projection roundtrip contract is declared" \
  '^theorem target_statement_of_completion_certificate_of_remaining_dependency_and_packaged_smooth_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency packaged smooth certificate target projection roundtrip contract is declared" \
  '^theorem target_statement_of_completion_certificate_of_poincareProofDependencies_and_packaged_smooth_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "remaining dependency packaged canonical smooth certificate target projection roundtrip contract is declared" \
  '^theorem target_statement_of_completion_certificate_of_remaining_dependency_and_packaged_canonical_smooth_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
check_decl "aggregate dependency packaged canonical smooth certificate target projection roundtrip contract is declared" \
  '^theorem target_statement_of_completion_certificate_of_poincareProofDependencies_and_packaged_canonical_smooth_three_sphere_statement_eq\b' Poincare/CanonicalBridges.lean
...
check_decl "completion certificate remaining dependency and project payload iff equality contract is declared" \
  '^theorem poincareCompletionCertificate_iff_remainingDependencyPackage_and_poincare_payload_eq\b' Poincare/CompletionTarget.lean
...
check_decl "completion certificate remaining dependency and canonical payload iff equality contract is declared" \
  '^theorem poincareCompletionCertificate_iff_remainingDependencyPackage_and_canonical_payload_eq\b' Poincare/CompletionTarget.lean
...
check_decl "completion certificate remaining dependency and target statement iff equality contract is declared" \
  '^theorem poincareCompletionCertificate_iff_remainingDependencyPackage_and_target_statement_eq\b' Poincare/CompletionTarget.lean
...
check_decl "completion certificate remaining dependency and canonical target iff equality contract is declared" \
  '^theorem poincareCompletionCertificate_iff_remainingDependencyPackage_and_canonical_target_eq\b' Poincare/CompletionTarget.lean
...
check_decl "completion certificate remaining dependency and completion criterion iff equality contract is declared" \
  '^theorem poincareCompletionCertificate_iff_remainingDependencyPackage_and_completion_criterion_eq\b' Poincare/CompletionTarget.lean
...
check_decl "remaining dependency project-payload package roundtrip contract is declared" \
...
check_decl "remaining dependency criterion roundtrip contract is declared" \
  '^theorem completion_criterion_of_completion_certificate_of_remaining_dependency_and_completion_criterion_eq\b' Poincare/CompletionTarget.lean
check_decl "remaining dependency package roundtrip contract is declared" \
  '^theorem remaining_dependency_package_of_completion_certificate_of_remaining_dependency_package_eq\b' Poincare/CompletionTarget.lean
...
check_decl "aggregate dependency package roundtrip contract is declared" \
  '^theorem poincareProofDependencies_of_completion_certificate_of_poincareProofDependencies_eq\b' Poincare/CompletionTarget.lean
check_decl "aggregate dependency project-payload package roundtrip contract is declared" \
...
check_decl "aggregate dependency criterion roundtrip contract is declared" \
  '^theorem completion_criterion_of_completion_certificate_of_poincareProofDependencies_and_completion_criterion_eq\b' Poincare/CompletionTarget.lean
...
check_decl "raw component certificate constructor remaining-dependency contract is declared" \
  '^theorem completion_certificate_of_components_to_remaining_dependency_eq\b' Poincare/CompletionTarget.lean
check_decl "raw component certificate constructor payload roundtrip contract is declared" \
  '^theorem poincareCompletionCertificate_components_payload_of_completion_certificate_of_components_eq\b' Poincare/CompletionTarget.lean
...
check_decl "component-slot certificate constructor remaining-dependency contract is declared" \
  '^theorem completion_certificate_of_component_requirements_to_remaining_dependency_eq\b' Poincare/CompletionTarget.lean
check_decl "component-slot certificate constructor payload roundtrip contract is declared" \
  '^theorem poincareCompletionCertificate_component_requirements_payload_of_completion_certificate_of_component_requirements_eq\b' Poincare/CompletionTarget.lean
...
check_decl "package-layer certificate constructor remaining-dependency contract is declared" \
  '^theorem completion_certificate_of_package_layer_requirements_to_remaining_dependency_eq\b' Poincare/CompletionTarget.lean
check_decl "package-layer certificate constructor payload roundtrip contract is declared" \
  '^theorem poincareCompletionCertificate_package_layer_requirements_payload_of_completion_certificate_of_package_layer_requirements_eq\b' Poincare/CompletionTarget.lean
...
check_decl "milestone certificate constructor remaining-dependency contract is declared" \
  '^theorem completion_certificate_of_milestone_requirements_to_remaining_dependency_eq\b' Poincare/CompletionTarget.lean
check_decl "milestone certificate constructor payload roundtrip contract is declared" \
  '^theorem poincareCompletionCertificate_milestone_requirements_payload_of_completion_certificate_of_milestone_requirements_eq\b' Poincare/CompletionTarget.lean
...
check_decl "raw component payload certificate constructor remaining-dependency contract is declared" \
  '^theorem completion_certificate_of_components_payload_to_remaining_dependency_eq\b' Poincare/CompletionTarget.lean
check_decl "raw component payload certificate constructor payload roundtrip contract is declared" \
  '^theorem poincareCompletionCertificate_components_payload_of_completion_certificate_of_components_payload_eq\b' Poincare/CompletionTarget.lean
...
check_decl "component-slot payload certificate constructor remaining-dependency contract is declared" \
  '^theorem completion_certificate_of_component_requirements_payload_to_remaining_dependency_eq\b' Poincare/CompletionTarget.lean
check_decl "component-slot payload certificate constructor payload roundtrip contract is declared" \
  '^theorem poincareCompletionCertificate_component_requirements_payload_of_completion_certificate_of_component_requirements_payload_eq\b' Poincare/CompletionTarget.lean
...
check_decl "package-layer payload certificate constructor remaining-dependency contract is declared" \
  '^theorem completion_certificate_of_package_layer_requirements_payload_to_remaining_dependency_eq\b' Poincare/CompletionTarget.lean
check_decl "package-layer payload certificate constructor payload roundtrip contract is declared" \
  '^theorem poincareCompletionCertificate_package_layer_requirements_payload_of_completion_certificate_of_package_layer_requirements_payload_eq\b' Poincare/CompletionTarget.lean
...
check_decl "milestone payload certificate constructor remaining-dependency contract is declared" \
  '^theorem completion_certificate_of_milestone_requirements_payload_to_remaining_dependency_eq\b' Poincare/CompletionTarget.lean
check_decl "milestone payload certificate constructor payload roundtrip contract is declared" \
  '^theorem poincareCompletionCertificate_milestone_requirements_payload_of_completion_certificate_of_milestone_requirements_payload_eq\b' Poincare/CompletionTarget.lean
...
check_decl "certified component requirements completion certificate remaining-dependency contract is declared" \
  '^theorem completion_certificate_of_component_extraction_derivation_requirements_to_remaining_dependency_eq\b' Poincare/CompletionTarget.lean
check_decl "certified component requirements payload completion certificate remaining-dependency contract is declared" \
  '^theorem completion_certificate_of_component_extraction_derivation_requirements_payload_to_remaining_dependency_eq\b' Poincare/CompletionTarget.lean
check_decl "certified component requirements completion certificate payload roundtrip contract is declared" \
  '^theorem poincareCompletionCertificate_component_requirements_payload_of_completion_certificate_of_component_extraction_derivation_requirements_eq\b' Poincare/CompletionTarget.lean
check_decl "certified component requirements payload completion certificate payload roundtrip contract is declared" \
  '^theorem poincareCompletionCertificate_component_requirements_payload_of_completion_certificate_of_component_extraction_derivation_requirements_payload_eq\b' Poincare/CompletionTarget.lean
...
check_decl "certified package-layer requirements completion certificate remaining-dependency contract is declared" \
  '^theorem completion_certificate_of_package_layer_extraction_derivation_requirements_to_remaining_dependency_eq\b' Poincare/CompletionTarget.lean
check_decl "certified package-layer requirements payload completion certificate remaining-dependency contract is declared" \
  '^theorem completion_certificate_of_package_layer_extraction_derivation_requirements_payload_to_remaining_dependency_eq\b' Poincare/CompletionTarget.lean
check_decl "certified package-layer requirements completion certificate payload roundtrip contract is declared" \
  '^theorem poincareCompletionCertificate_package_layer_requirements_payload_of_completion_certificate_of_package_layer_extraction_derivation_requirements_eq\b' Poincare/CompletionTarget.lean
check_decl "certified package-layer requirements payload completion certificate payload roundtrip contract is declared" \
  '^theorem poincareCompletionCertificate_package_layer_requirements_payload_of_completion_certificate_of_package_layer_extraction_derivation_requirements_payload_eq\b' Poincare/CompletionTarget.lean
...
check_decl "certified milestone requirements completion certificate remaining-dependency contract is declared" \
  '^theorem completion_certificate_of_milestone_extraction_derivation_requirements_to_remaining_dependency_eq\b' Poincare/CompletionTarget.lean
check_decl "certified milestone requirements payload completion certificate remaining-dependency contract is declared" \
  '^theorem completion_certificate_of_milestone_extraction_derivation_requirements_payload_to_remaining_dependency_eq\b' Poincare/CompletionTarget.lean
check_decl "certified milestone requirements completion certificate payload roundtrip contract is declared" \
  '^theorem poincareCompletionCertificate_milestone_requirements_payload_of_completion_certificate_of_milestone_extraction_derivation_requirements_eq\b' Poincare/CompletionTarget.lean
check_decl "certified milestone requirements payload completion certificate payload roundtrip contract is declared" \
  '^theorem poincareCompletionCertificate_milestone_requirements_payload_of_completion_certificate_of_milestone_extraction_derivation_requirements_payload_eq\b' Poincare/CompletionTarget.lean
...
check_decl "remaining dependency raw component projection roundtrip contract is declared" \
  '^theorem remaining_dependency_package_of_completion_certificate_of_remaining_dependency_component_requirements_eq\b' Poincare/CompletionTarget.lean
check_decl "remaining dependency raw package-layer projection roundtrip contract is declared" \
  '^theorem remaining_dependency_package_of_completion_certificate_of_remaining_dependency_package_layer_requirements_eq\b' Poincare/CompletionTarget.lean
check_decl "remaining dependency raw milestone projection roundtrip contract is declared" \
  '^theorem remaining_dependency_package_of_completion_certificate_of_remaining_dependency_milestone_requirements_eq\b' Poincare/CompletionTarget.lean
check_decl "remaining dependency certified component projection roundtrip contract is declared" \
  '^theorem remaining_dependency_package_of_completion_certificate_of_remaining_dependency_component_extraction_derivation_requirements_eq\b' Poincare/CompletionTarget.lean
check_decl "remaining dependency certified package-layer projection roundtrip contract is declared" \
  '^theorem remaining_dependency_package_of_completion_certificate_of_remaining_dependency_package_layer_extraction_derivation_requirements_eq\b' Poincare/CompletionTarget.lean
check_decl "remaining dependency certified milestone projection roundtrip contract is declared" \
  '^theorem remaining_dependency_package_of_completion_certificate_of_remaining_dependency_milestone_extraction_derivation_requirements_eq\b' Poincare/CompletionTarget.lean
check_decl "remaining dependency aggregate extraction projection roundtrip contract is declared" \
  '^theorem remaining_dependency_package_of_completion_certificate_of_aggregate_extraction_derivation_dependencies_eq\b' Poincare/CompletionTarget.lean
check_decl "remaining dependency extraction projection route roundtrip contract is declared" \
  '^theorem remaining_dependency_package_of_completion_certificate_of_extraction_derivation_dependency_projections_eq\b' Poincare/CompletionTarget.lean
check_decl "aggregate dependency raw component projection roundtrip contract is declared" \
  '^theorem poincareProofDependencies_of_completion_certificate_of_poincareProofDependencies_component_requirements_eq\b' Poincare/CompletionTarget.lean
check_decl "aggregate dependency raw package-layer projection roundtrip contract is declared" \
  '^theorem poincareProofDependencies_of_completion_certificate_of_poincareProofDependencies_package_layer_requirements_eq\b' Poincare/CompletionTarget.lean
check_decl "aggregate dependency raw milestone projection roundtrip contract is declared" \
  '^theorem poincareProofDependencies_of_completion_certificate_of_poincareProofDependencies_milestone_requirements_eq\b' Poincare/CompletionTarget.lean
check_decl "aggregate dependency certified component projection roundtrip contract is declared" \
  '^theorem poincareProofDependencies_of_completion_certificate_of_poincareProofDependencies_component_extraction_derivation_requirements_eq\b' Poincare/CompletionTarget.lean
check_decl "aggregate dependency certified package-layer projection roundtrip contract is declared" \
  '^theorem poincareProofDependencies_of_completion_certificate_of_poincareProofDependencies_package_layer_extraction_derivation_requirements_eq\b' Poincare/CompletionTarget.lean
check_decl "aggregate dependency certified milestone projection roundtrip contract is declared" \
  '^theorem poincareProofDependencies_of_completion_certificate_of_poincareProofDependencies_milestone_extraction_derivation_requirements_eq\b' Poincare/CompletionTarget.lean
check_decl "aggregate dependency aggregate extraction projection roundtrip contract is declared" \
  '^theorem poincareProofDependencies_of_completion_certificate_of_poincareProofDependencies_aggregate_extraction_derivation_eq\b' Poincare/CompletionTarget.lean
check_decl "aggregate dependency extraction projection route roundtrip contract is declared" \
  '^theorem poincareProofDependencies_of_completion_certificate_of_poincareProofDependencies_extraction_derivation_projections_eq\b' Poincare/CompletionTarget.lean
...
#check Poincare.target_statement_of_completion_certificate_of_remaining_dependency_and_canonical_three_sphere_statement_eq
#check Poincare.poincare_completion_payload_of_completion_certificate_of_remaining_dependency_and_canonical_three_sphere_statement_eq
#check Poincare.canonical_completion_payload_of_completion_certificate_of_remaining_dependency_and_canonical_three_sphere_statement_eq
#check Poincare.canonical_completion_target_of_completion_certificate_of_remaining_dependency_and_canonical_three_sphere_statement_eq
#check Poincare.completion_criterion_of_completion_certificate_of_remaining_dependency_and_canonical_three_sphere_statement_eq
#check Poincare.target_statement_of_completion_certificate_of_poincareProofDependencies_and_canonical_three_sphere_statement_eq
#check Poincare.poincare_completion_payload_of_completion_certificate_of_poincareProofDependencies_and_canonical_three_sphere_statement_eq
#check Poincare.canonical_completion_payload_of_completion_certificate_of_poincareProofDependencies_and_canonical_three_sphere_statement_eq
...
#check Poincare.poincare_statement_of_remaining_dependency_and_packaged_reverse_canonical_smooth_three_sphere_statement
#check Poincare.completion_criterion_of_remaining_dependency_and_packaged_reverse_canonical_smooth_three_sphere_statement
#check Poincare.poincare_statement_of_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement
#check Poincare.completion_criterion_of_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement
#check Poincare.poincare_completion_payload_of_remaining_dependency_and_packaged_reverse_canonical_smooth_three_sphere_statement
#check Poincare.poincare_completion_payload_of_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement
#check Poincare.canonical_completion_payload_of_remaining_dependency_and_packaged_reverse_canonical_smooth_three_sphere_statement
#check Poincare.canonical_completion_payload_of_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement
#check Poincare.canonical_completion_target_of_remaining_dependency_and_packaged_reverse_canonical_smooth_three_sphere_statement
#check Poincare.canonical_completion_criterion_of_remaining_dependency_and_packaged_reverse_canonical_smooth_three_sphere_statement
#check Poincare.canonical_completion_target_of_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement
#check Poincare.canonical_completion_criterion_of_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement
#check Poincare.canonical_three_sphere_statement_of_remaining_dependency_and_packaged_reverse_canonical_smooth_three_sphere_statement
#check Poincare.canonical_three_sphere_statement_of_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement
#check Poincare.completion_certificate_of_remaining_dependency_and_packaged_reverse_canonical_smooth_three_sphere_statement
#check Poincare.completion_certificate_of_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement
...
#check Poincare.poincareCompletionCertificate_iff_remainingDependencyPackage_and_packaged_smooth_statement_payload_eq
#check Poincare.poincareCompletionCertificate_iff_poincareProofDependencies_and_packaged_smooth_statement_payload_eq
#check Poincare.poincareCompletionCertificate_iff_remainingDependencyPackage_and_packaged_canonical_smooth_three_sphere_statement_payload_eq
#check Poincare.poincareCompletionCertificate_iff_poincareProofDependencies_and_packaged_canonical_smooth_three_sphere_statement_payload_eq
...
#check Poincare.poincareCompletionCertificate_iff_remainingDependencyPackage_and_poincare_payload_eq
...
#check Poincare.poincareCompletionCertificate_iff_remainingDependencyPackage_and_target_statement_eq
...
#check Poincare.poincareCompletionCertificate_iff_remainingDependencyPackage_and_canonical_payload_eq
...
#check Poincare.poincareCompletionCertificate_iff_remainingDependencyPackage_and_canonical_target_eq
...
#check Poincare.poincareCompletionCertificate_iff_remainingDependencyPackage_and_completion_criterion_eq
...
#check Poincare.remaining_dependency_package_of_completion_certificate_of_remaining_dependency_and_canonical_payload_eq
#check Poincare.canonical_completion_payload_of_completion_certificate_of_remaining_dependency_and_canonical_payload_eq
#check Poincare.remaining_dependency_package_of_completion_certificate_of_remaining_dependency_and_target_statement_eq
#check Poincare.target_statement_of_completion_certificate_of_remaining_dependency_and_target_statement_eq
#check Poincare.remaining_dependency_package_of_completion_certificate_of_remaining_dependency_and_canonical_target_eq
#check Poincare.canonical_completion_target_of_completion_certificate_of_remaining_dependency_and_canonical_target_eq
#check Poincare.remaining_dependency_package_of_completion_certificate_of_remaining_dependency_and_completion_criterion_eq
...
#check Poincare.poincareProofDependencies_of_completion_certificate_of_poincareProofDependencies_and_poincare_payload_eq
...
#check Poincare.poincareProofDependencies_of_completion_certificate_of_poincareProofDependencies_and_canonical_payload_eq
...
#check Poincare.poincareProofDependencies_of_completion_certificate_of_poincareProofDependencies_and_target_statement_eq
#check Poincare.target_statement_of_completion_certificate_of_poincareProofDependencies_and_target_statement_eq
#check Poincare.poincareProofDependencies_of_completion_certificate_of_poincareProofDependencies_and_canonical_target_eq
...
#check Poincare.poincareProofDependencies_of_completion_certificate_of_poincareProofDependencies_and_completion_criterion_eq
...
#check Poincare.remaining_dependency_package_of_completion_certificate_of_remaining_dependency_and_packaged_reverse_canonical_smooth_three_sphere_statement_eq
#check Poincare.poincareProofDependencies_of_completion_certificate_of_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement_eq
...
#check Poincare.canonical_three_sphere_statement_of_completion_certificate_of_remaining_dependency_and_packaged_reverse_canonical_smooth_three_sphere_statement_eq
#check Poincare.canonical_three_sphere_statement_of_completion_certificate_of_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement_eq
...
#check Poincare.canonical_completion_target_of_completion_certificate_of_remaining_dependency_and_packaged_reverse_canonical_smooth_three_sphere_statement_eq
#check Poincare.completion_criterion_of_completion_certificate_of_remaining_dependency_and_packaged_reverse_canonical_smooth_three_sphere_statement_eq
#check Poincare.canonical_completion_target_of_completion_certificate_of_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement_eq
#check Poincare.completion_criterion_of_completion_certificate_of_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement_eq
...
#check Poincare.poincare_completion_payload_of_completion_certificate_of_remaining_dependency_and_packaged_reverse_canonical_smooth_three_sphere_statement_eq
#check Poincare.canonical_completion_payload_of_completion_certificate_of_remaining_dependency_and_packaged_reverse_canonical_smooth_three_sphere_statement_eq
#check Poincare.poincare_completion_payload_of_completion_certificate_of_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement_eq
#check Poincare.canonical_completion_payload_of_completion_certificate_of_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement_eq
...
#check Poincare.target_statement_of_completion_certificate_of_remaining_dependency_and_packaged_reverse_canonical_smooth_three_sphere_statement_eq
#check Poincare.target_statement_of_completion_certificate_of_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement_eq
...
#check Poincare.poincare_statement_of_remaining_dependency_and_packaged_reverse_canonical_smooth_three_sphere_statement_eq
#check Poincare.completion_criterion_of_remaining_dependency_and_packaged_reverse_canonical_smooth_three_sphere_statement_eq
#check Poincare.poincare_statement_of_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement_eq
#check Poincare.completion_criterion_of_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement_eq
#check Poincare.poincare_completion_payload_of_remaining_dependency_and_packaged_reverse_canonical_smooth_three_sphere_statement_eq
#check Poincare.poincare_completion_payload_of_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement_eq
#check Poincare.canonical_completion_payload_of_remaining_dependency_and_packaged_reverse_canonical_smooth_three_sphere_statement_eq
#check Poincare.canonical_completion_payload_of_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement_eq
...
#check Poincare.poincare_statement_of_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement_to_remaining_dependency_eq
#check Poincare.completion_criterion_of_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement_to_remaining_dependency_eq
#check Poincare.poincare_completion_payload_of_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement_to_remaining_dependency_eq
#check Poincare.canonical_completion_payload_of_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement_to_remaining_dependency_eq
#check Poincare.canonical_completion_target_of_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement_to_remaining_dependency_eq
#check Poincare.canonical_completion_criterion_of_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement_to_remaining_dependency_eq
#check Poincare.canonical_three_sphere_statement_of_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement_to_remaining_dependency_eq
#check Poincare.completion_certificate_of_remaining_dependency_and_packaged_reverse_canonical_smooth_three_sphere_statement_eq
#check Poincare.completion_certificate_of_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement_to_remaining_dependency_eq
#check Poincare.completion_certificate_of_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement_eq
...
#check Poincare.packaged_smooth_statement_payload_iff_poincareProofDependencies_remainingDependencyPackage_eq
#check Poincare.packaged_canonical_smooth_three_sphere_statement_payload_iff_poincareProofDependencies_remainingDependencyPackage_eq
#check Poincare.poincareCompletionCertificate_iff_remainingDependencyPackage_and_packaged_smooth_statement_payload_eq
#check Poincare.poincareCompletionCertificate_iff_poincareProofDependencies_and_packaged_smooth_statement_payload_eq
#check Poincare.poincareCompletionCertificate_iff_remainingDependencyPackage_and_packaged_canonical_smooth_three_sphere_statement_payload_eq
#check Poincare.poincareCompletionCertificate_iff_poincareProofDependencies_and_packaged_canonical_smooth_three_sphere_statement_payload_eq
...
#check Poincare.canonical_completion_target_of_remaining_dependency_and_packaged_reverse_canonical_smooth_three_sphere_statement_eq
#check Poincare.canonical_completion_criterion_of_remaining_dependency_and_packaged_reverse_canonical_smooth_three_sphere_statement_eq
#check Poincare.canonical_three_sphere_statement_of_remaining_dependency_and_packaged_reverse_canonical_smooth_three_sphere_statement_eq
#check Poincare.canonical_completion_target_of_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement_eq
#check Poincare.canonical_completion_criterion_of_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement_eq
#check Poincare.canonical_three_sphere_statement_of_poincareProofDependencies_and_packaged_reverse_canonical_smooth_three_sphere_statement_eq
