...
project-statement full payload projections and constructors, so the checked
certificate can be reconstructed from the project-level target-statement payload
