...
payloads record the `C∞` smoothability statement, smooth or canonical-smooth
input, induced topological target, and completion criterion. The packaged
...
statement from each packaged route.
