...
/-- Construct the positive-time automatic finite-nerve boundary directly from Bochner
norm fields. -/
noncomputable def
  ...
  letI : BorelSpace M := ⟨rfl⟩
  exact
    NormalizedFlowSphereCompactMeanEnergyMeasureReactionDecayHausdorffJointScalarDerivativeCovRicciSubordinatePartitionPositiveEinsteinAnalyticData3.ofBochnerNormFields
...
/-- Construct the positive-time automatic finite-nerve boundary from Bochner norm
fields using canonical Ricci-variation regularity. -/
noncomputable def
  ...
  exact
    NormalizedFlowSphereCompactMeanEnergyMeasureReactionDecayHausdorffJointScalarDerivativeCovRicciSubordinatePartitionPositiveEinsteinAnalyticData3.ofBochnerNormFieldsCanonical
      reaction compactTensorReferenceControl hRicNorm₂
      hLaplacianJointContinuous hRoughJointContinuous scalarSubordinateGeometry

/-- Construct the positive-time automatic finite-nerve boundary from the joint
Bochner fields using canonical Ricci regularity. -/
noncomputable def
    AutomaticFiniteNerveTetrahedralStarSmoothingReactionDecayHausdorffJointScalarDerivativeCovRicciSubordinatePartitionPositiveEinsteinGenericInverseEndpointODEPositiveTimeOverlapCompactHistoryBoundaryData3.ofBochnerFieldsCanonical
    {M : Type u} [TopologicalSpace M] [T2Space M]
    [ambientChartedSpace : ChartedSpace (EuclideanSpace ℝ (Fin 3)) M]
    [CompactSpace M] [SimplyConnectedSpace M]
    (tetrahedralStarProvider : FiniteTetrahedralStarPresentationProvider3 M)
  ...
  letI : BorelSpace M := ⟨rfl⟩
  exact
    NormalizedFlowSphereCompactMeanEnergyMeasureReactionDecayHausdorffJointScalarDerivativeCovRicciSubordinatePartitionPositiveEinsteinAnalyticData3.ofBochnerFieldsCanonical
      reaction compactTensorReferenceControl hLaplacianJointContinuous
      hRoughJointContinuous scalarSubordinateGeometry
