...
/--
One-point recognition and the ordinary surgery package family also keep the
full smooth-structure derivation fields synchronized with the transported
smooth-manifold route and the concrete one-point finite-extinction payload.
The smooth-structure derivation fields are projected from the same transported
smooth-manifold package fields used to produce the finite-extinction target.
-/
theorem onePointRecognition_smoothStructureDerivation_transportedSmoothabilityStatements_and_finiteExtinctionPayload_of_surgeryPackages
    (recognize : OnePointThreeSpaceRecognitionStatement.{0})
    (surgeryPackages :
      ∀ (M : Type) [TopologicalSpace M] [T2Space M]
        [ChartedSpace ThreeManifoldModel M]
    ...
    ∃ transportedFields : SmoothabilityPackageTransportedSmoothManifoldFields.{0},
      smoothFields =
          transportedFields.toSmoothabilityPackageTransportedBridgeFields.toSmoothabilityPackageSmoothStructureDerivationFields ∧
        transportedFields =
          smoothabilityPackageTransportedSmoothManifoldFields_of_onePointRecognition
            recognize ∧
        SmoothabilityTransportedBridgeStatement.{0} ∧
  ...
  exact
    ...
    , rfl
    , rfl
    , transportedFields.transportedBridge
...
/--
One-point recognition selects the transported smooth-manifold fields, their
transported bridge prefix, and the smooth-structure derivation prefix from the
same constructed route while preserving the concrete transported
finite-extinction payload.  This is the field-synchronized version of the
transported smoothability endpoint used before the ambient charted-space
comparison blocker.
-/
theorem onePointRecognition_selected_transportedSmoothManifold_bridge_smoothStructure_and_finiteExtinctionPayload_of_surgeryPackages
    (recognize : OnePointThreeSpaceRecognitionStatement.{0})
    (surgeryPackages :
      ∀ (M : Type) [TopologicalSpace M] [T2Space M]
        [ChartedSpace ThreeManifoldModel M]
...
/--
The selected transported smooth-manifold endpoint also recovers the
regularity-lowered transported bridge field directly from the selected
smooth-manifold package field.  The recovered bridge, the selected bridge
prefix, the smooth-structure prefix, and the finite-extinction payload all
come from the same transported smooth-manifold route.
-/
theorem onePointRecognition_selected_transportedSmoothManifold_recoveredBridge_and_finiteExtinctionPayload_of_surgeryPackages
    (recognize : OnePointThreeSpaceRecognitionStatement.{0})
    (surgeryPackages :
      ∀ (M : Type) [TopologicalSpace M] [T2Space M]
        [ChartedSpace ThreeManifoldModel M]
...
/--
The selected transported one-point smoothability route also exposes the actual
charted-space finite-extinction witness for the one-point compactification
model.  This avoids leaving downstream finite-extinction consumers with only
the existential payload proposition: the selected transported smooth-manifold
fields, recovered bridge, canonical surgery-family specialization, and a
concrete `FiniteExtinctionByRicciFlowWithSurgery` witness are retained in one
endpoint.
-/
theorem onePointRecognition_selected_transportedSmoothManifold_recoveredBridge_canonicalSurgeryFamily_and_finiteExtinctionWitness
    (recognize : OnePointThreeSpaceRecognitionStatement.{0})
    (surgeryPackages :
      ∀ (M : Type) [TopologicalSpace M] [T2Space M]
        [ChartedSpace ThreeManifoldModel M]
  ...
  let surgeryFamily : OnePointTransportedSurgeryPackageFamily :=
    onePointTransportedSurgeryPackageFamily_of_surgeryPackages
      surgeryPackages
  have finiteExtinctionPayload : OnePointTransportedFiniteExtinctionPayload :=
    onePointTransportedFiniteExtinctionPayload_of_transportedSmoothManifoldFields
      transportedFields surgeryFamily
  rcases finiteExtinctionPayload with ⟨charted, finiteExtinction⟩
  exact
    ⟨ transportedFields
    , bridgeFields
    , recoveredBridge
    ...
    , bridgeFields.transportedBridge
    , transportedFields.transportedSmoothManifold
    , ⟨charted, finiteExtinction⟩
    ⟩

/--
The selected transported one-point smoothability route retains the canonical
finite-extinction payload proposition and the concrete witness extracted from
that same payload.  This keeps the transported smooth-manifold fields,
recovered bridge, canonical surgery-family specialization, payload equality,
and actual charted-space finite-extinction witness synchronized for downstream
finite-extinction consumers.
-/
theorem onePointRecognition_selected_transportedSmoothManifold_recoveredBridge_canonicalSurgeryFamily_finiteExtinctionPayload_andWitness
    (recognize : OnePointThreeSpaceRecognitionStatement.{0})
    (surgeryPackages :
      ∀ (M : Type) [TopologicalSpace M] [T2Space M]
        [ChartedSpace ThreeManifoldModel M]
...
/--
The selected transported one-point smoothability route can also keep the raw
package-field projections that sit immediately before the recovered bridge.
This endpoint synchronizes the transported smooth-manifold package field, the
transported bridge package field, the bridge recovered by regularity lowering,
the canonical surgery-family specialization, the finite-extinction payload
equality, and the extracted charted-space finite-extinction witness.
-/
theorem onePointRecognition_selected_transportedPackageFields_recoveredBridge_canonicalSurgeryFamily_finiteExtinctionPayload_andWitness
    (recognize : OnePointThreeSpaceRecognitionStatement.{0})
    (surgeryPackages :
      ∀ (M : Type) [TopologicalSpace M] [T2Space M]
        [ChartedSpace ThreeManifoldModel M]
    ...
    ∃ transportedFields : SmoothabilityPackageTransportedSmoothManifoldFields.{0},
    ∃ bridgeFields : SmoothabilityPackageTransportedBridgeFields.{0},
    ∃ transportedPackageField :
      SmoothabilityTransportedSmoothManifoldPackageField.{0},
    ∃ bridgePackageField : SmoothabilityTransportedBridgePackageField.{0},
    ∃ recoveredBridge : SmoothabilityTransportedBridgePackageField.{0},
    ∃ smoothFields : SmoothabilityPackageSmoothStructureDerivationFields.{0},
    ∃ surgeryFamily : OnePointTransportedSurgeryPackageFamily,
    ∃ finiteExtinctionPayload : OnePointTransportedFiniteExtinctionPayload,
    ∃ charted : ChartedSpace ThreeManifoldModel
      ...
      FiniteExtinctionByRicciFlowWithSurgery
        ...
        transportedPackageField =
          transportedFields.toSmoothabilityTransportedSmoothManifoldPackageField ∧
        bridgePackageField =
          bridgeFields.toSmoothabilityTransportedBridgePackageField ∧
        recoveredBridge =
          smoothabilityTransportedBridgePackageField_of_transportedSmoothManifoldPackageField
            transportedPackageField ∧
        recoveredBridge.transportedBridge =
          bridgePackageField.transportedBridge ∧
        smoothFields =
          bridgeFields.toSmoothabilityPackageSmoothStructureDerivationFields ∧
        surgeryFamily =
          onePointTransportedSurgeryPackageFamily_of_surgeryPackages
  ...
  let bridgeFields : SmoothabilityPackageTransportedBridgeFields.{0} :=
    transportedFields.toSmoothabilityPackageTransportedBridgeFields
  let transportedPackageField :
      SmoothabilityTransportedSmoothManifoldPackageField.{0} :=
    transportedFields.toSmoothabilityTransportedSmoothManifoldPackageField
  let bridgePackageField : SmoothabilityTransportedBridgePackageField.{0} :=
    bridgeFields.toSmoothabilityTransportedBridgePackageField
  let recoveredBridge : SmoothabilityTransportedBridgePackageField.{0} :=
    smoothabilityTransportedBridgePackageField_of_transportedSmoothManifoldPackageField
      transportedPackageField
...
/--
The selected transported smoothability route bundled as a field package for
downstream final-certificate consumers.  It records the smooth-structure field
package, both transported package-field projections, the recovered bridge field,
the canonical one-point surgery-family specialization, and the finite-extinction
payload extracted from that same route.
-/
structure OnePointTransportedFinalCertificateFields
    (recognize : OnePointThreeSpaceRecognitionStatement.{0})
    (surgeryPackages :
      ∀ (M : Type) [TopologicalSpace M] [T2Space M]
        [ChartedSpace ThreeManifoldModel M]
        [SimplyConnectedSpace M] [CompactSpace M]
        [IsManifold ThreeManifoldModelWithCorners 1 M],
          Nonempty (Σ n : ℕ∞ω, FiniteExtinctionSurgeryPackage n M)) where
  transportedFields : SmoothabilityPackageTransportedSmoothManifoldFields.{0}
  bridgeFields : SmoothabilityPackageTransportedBridgeFields.{0}
  transportedPackageField :
    SmoothabilityTransportedSmoothManifoldPackageField.{0}
  ...
  finiteExtinctionPayload_eq :
    finiteExtinctionPayload =
      onePointTransportedFiniteExtinctionPayload_of_transportedSmoothManifoldFields
        transportedFields surgeryFamily
  transportedBridgeStatement : SmoothabilityTransportedBridgeStatement.{0}
  transportedSmoothManifoldStatement :
    SmoothabilityTransportedSmoothManifoldStatement.{0}

/--
One-point recognition constructs the final-certificate field package through
the transported smoothability route before the ambient charted-space comparison
blocker.  The finite-extinction payload is produced from the same transported
smooth-manifold package field retained in the package.
-/
def onePointTransportedFinalCertificateFieldsOfOnePointRecognition
    (recognize : OnePointThreeSpaceRecognitionStatement.{0})
    (surgeryPackages :
      ∀ (M : Type) [TopologicalSpace M] [T2Space M]
        [ChartedSpace ThreeManifoldModel M]
        ...
        [IsManifold ThreeManifoldModelWithCorners 1 M],
          Nonempty (Σ n : ℕ∞ω, FiniteExtinctionSurgeryPackage n M)) :
    OnePointTransportedFinalCertificateFields recognize surgeryPackages := by
  let transportedFields :
      SmoothabilityPackageTransportedSmoothManifoldFields.{0} :=
    smoothabilityPackageTransportedSmoothManifoldFields_of_onePointRecognition
      recognize
  ...
  have finiteExtinctionPayload : OnePointTransportedFiniteExtinctionPayload :=
    onePointTransportedFiniteExtinctionPayload_of_transportedSmoothManifoldFields
      transportedFields surgeryFamily
  exact
    { transportedFields := transportedFields
      bridgeFields := bridgeFields
      transportedPackageField := transportedPackageField
      bridgePackageField := bridgePackageField
      recoveredBridge := recoveredBridge
      smoothFields := smoothFields
      surgeryFamily := surgeryFamily
      finiteExtinctionPayload := finiteExtinctionPayload
      transportedFields_eq := rfl
      bridgeFields_eq := rfl
      transportedPackageField_eq := rfl
      bridgePackageField_eq := rfl
      recoveredBridge_eq := rfl
      recoveredBridge_transport_eq := rfl
      smoothFields_eq := rfl
      surgeryFamily_eq := rfl
      finiteExtinctionPayload_eq := by apply Subsingleton.elim
      transportedBridgeStatement := bridgeFields.transportedBridge
      transportedSmoothManifoldStatement :=
        transportedFields.transportedSmoothManifold }

/--
The constructed final-certificate field package exposes the synchronized
finite-extinction payload and the transported smoothability statements as
projection data for downstream certificate assembly.
-/
theorem onePointTransportedFinalCertificateFields_payload_and_statements
    (recognize : OnePointThreeSpaceRecognitionStatement.{0})
    (surgeryPackages :
      ∀ (M : Type) [TopologicalSpace M] [T2Space M]
        [ChartedSpace ThreeManifoldModel M]
...
/--
The constructed final-certificate field package opens its finite-extinction
payload into the transported one-point charted-space witness and the
finite-extinction witness produced from that same transported smoothability
route.  This keeps the retained package fields usable by final-certificate
code that needs the concrete one-point finite-extinction target rather than the
opaque payload proposition.
-/
theorem onePointTransportedFinalCertificateFields_opened_finiteExtinction_payload
    (recognize : OnePointThreeSpaceRecognitionStatement.{0})
    (surgeryPackages :
      ∀ (M : Type) [TopologicalSpace M] [T2Space M]
        [ChartedSpace ThreeManifoldModel M]
...
/--
The constructed one-point final-certificate field package can also expose its
main transported package-field objects as named witnesses.  This keeps the
transported smooth-manifold package field, transported bridge package field,
recovered bridge, smooth-structure field bundle, canonical one-point surgery
family, finite-extinction payload, and opened finite-extinction witness tied to
the same selected field package.
-/
theorem onePointTransportedFinalCertificateFields_named_package_fields_and_opened_finiteExtinction_payload
    (recognize : OnePointThreeSpaceRecognitionStatement.{0})
    (surgeryPackages :
      ∀ (M : Type) [TopologicalSpace M] [T2Space M]
        [ChartedSpace ThreeManifoldModel M]
    ...
    ∃ charted : ChartedSpace ThreeManifoldModel
      ...
      ∃ finiteExtinction :
        FiniteExtinctionByRicciFlowWithSurgery
          (OnePoint (EuclideanSpace ℝ (Fin 3))),
        transportedPackageField = fields.transportedPackageField ∧
          bridgePackageField = fields.bridgePackageField ∧
          recoveredBridge = fields.recoveredBridge ∧
          smoothFields = fields.smoothFields ∧
          surgeryFamily = fields.surgeryFamily ∧
          finiteExtinctionPayload = fields.finiteExtinctionPayload ∧
          transportedPackageField =
            fields.transportedFields.toSmoothabilityTransportedSmoothManifoldPackageField ∧
          bridgePackageField =
            fields.bridgeFields.toSmoothabilityTransportedBridgePackageField ∧
          ...
          finiteExtinctionPayload =
            onePointTransportedFiniteExtinctionPayload_of_transportedSmoothManifoldFields
              fields.transportedFields surgeryFamily ∧
          finiteExtinctionPayload = ⟨charted, finiteExtinction⟩ ∧
          fields.transportedBridgeStatement =
            fields.bridgeFields.transportedBridge ∧
          fields.transportedSmoothManifoldStatement =
