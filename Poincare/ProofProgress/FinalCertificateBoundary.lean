...
/--
The direct topology-assembly payload route can retain the all-witness
completion-criteria function alongside its public/canonical payload objects and
a fixed witness criterion.  This gives final-certificate consumers one
proof-bearing endpoint where the object-level payloads, the checked certificate,
and the witness-specialized criterion are all synchronized.
-/
theorem finalAssemblySubobligationBoundaryInputs_topologyAssembly_direct_payloads_allCriteria_and_witnessCriterion
    (inputs : FinalAssemblySubobligationBoundaryInputs.{u})
    (witness : Type u) :
    ∃ minimalInputs : FinalCertificateMinimalPackageInputs.{u},
    ∃ primitiveInputs : FinalCertificatePrimitiveInputs.{u},
...
/--
The promoted three-package boundary can be retained while opening the direct
topology-assembly payload route from sub-obligation inputs.  This endpoint keeps
the promoted boundary fields, the minimal and primitive final-certificate
inputs, the public/canonical payload objects, the all-witness criterion family,
and the fixed witness criterion synchronized in one proof object.
-/
theorem finalAssemblySubobligationBoundaryInputs_promotedBoundary_topologyAssembly_direct_payloads_allCriteria_and_witnessCriterion
    (inputs : FinalAssemblySubobligationBoundaryInputs.{u})
    (witness : Type u) :
    ...
    ∃ allCriteria :
      ...
      promoted =
        ...
        minimalInputs =
          finalCertificateMinimalPackageInputs_of_finalAssemblyPackageBoundaryInputs
            promoted ∧
        minimalInputs.smoothability = promoted.smoothability ∧
        minimalInputs.finiteExtinction = promoted.finiteExtinction ∧
        primitiveInputs =
          finalCertificatePrimitiveInputs_of_minimalPackageInputs minimalInputs
            (extinction_implies_sphere_of_topology_package
              promoted.topology) ∧
        primitiveInputs.universalFiniteExtinction =
          universalFiniteExtinctionStatement_of_smoothability_and_surgery_packages
            promoted.smoothability promoted.finiteExtinction ∧
        primitiveInputs.extinctionImpliesSphere =
...
/--
Fully opened final-certificate handoff from sub-obligation inputs.  This keeps
the promoted package boundary, package-layer requirements, component
requirements, full/project/canonical assembly outputs, direct topology-assembly
payloads, all-witness criterion family, and fixed witness criterion in one
consumer theorem.  It is the final-certificate collapse surface after finite
extinction sub-obligations have been promoted to the package layer.
-/
theorem finalAssemblySubobligationBoundaryInputs_promotedBoundary_requirements_fullAssembly_topologyAssembly_and_completionCriteria
    (inputs : FinalAssemblySubobligationBoundaryInputs.{u})
    (witness : Type u) :
    ∃ promoted : FinalAssemblyPackageBoundaryInputs.{u},
    ∃ minimalInputs : FinalCertificateMinimalPackageInputs.{u},
...
/--
Field-opened promoted-boundary final-certificate handoff.  This keeps the
package/component requirements and full/project/canonical assembly payloads
together with the explicitly named topology-assembly fields: public statement,
checked certificate, nonempty certificate, canonical target, public/canonical
payload objects, all-witness completion criteria, and one fixed witness
criterion.
-/
theorem finalAssemblySubobligationBoundaryInputs_promotedBoundary_requirements_fullAssembly_topologyAssembly_fields_and_completionCriteria
    (inputs : FinalAssemblySubobligationBoundaryInputs.{u})
    (witness : Type u) :
    ∃ promoted : FinalAssemblyPackageBoundaryInputs.{u},
    ∃ minimalInputs : FinalCertificateMinimalPackageInputs.{u},
      ...
      promoted =
        ...
        primitiveInputs =
          finalCertificatePrimitiveInputs_of_minimalPackageInputs minimalInputs
            (extinction_implies_sphere_of_topology_package
              promoted.topology) ∧
        publicStatement = topologyAssemblyPayload.publicStatement ∧
        checkedCertificate = topologyAssemblyPayload.checkedCertificate ∧
        nonemptyCertificate = topologyAssemblyPayload.nonemptyCertificate ∧
        canonicalTarget = topologyAssemblyPayload.canonicalTarget ∧
        publicPayload = topologyAssemblyPayload.publicPayload ∧
        canonicalPayload = topologyAssemblyPayload.canonicalPayload ∧
        publicPayload = ⟨publicStatement, allCriteria⟩ ∧
        ...
        allCriteria =
          (fun witness =>
            completion_criterion_of_finalCertificateMinimalPackageInputs_and_topologyPackage
              witness minimalInputs promoted.topology) ∧
        publicStatement =
          poincare_conjecture_of_completion_certificate checkedCertificate ∧
        checkedCertificate =
          completion_certificate_of_remainingDependencyPackage_and_finalCertificatePrimitiveInputs
            (remainingDependencyPackage_of_finalAssemblyPackageBoundaryInputs
              promoted) primitiveInputs ∧
  ...
  let topologyAssemblyPayload :
      FinalCertificateTopologyAssemblyPayload minimalInputs promoted.topology :=
    finalCertificateTopologyAssemblyPayload minimalInputs promoted.topology
  let publicStatement : PoincareConjectureStatement.{u} :=
    topologyAssemblyPayload.publicStatement
  let checkedCertificate : PoincareCompletionCertificate.{u} :=
    topologyAssemblyPayload.checkedCertificate
  let nonemptyCertificate : Nonempty PoincareCompletionCertificate.{u} :=
    topologyAssemblyPayload.nonemptyCertificate
...
/--
Remaining-dependency opened final-certificate handoff.  This strengthens the
field-opened topology-assembly endpoint by naming the remaining dependency
package recovered from the promoted boundary, and by retaining the checked
certificate equalities through both certificate constructors: the
remaining-dependency/primitive-input route and the minimal-input/topology route.
-/
theorem finalAssemblySubobligationBoundaryInputs_promotedBoundary_remainingDependency_topologyAssembly_fields_and_completionCriteria
    (inputs : FinalAssemblySubobligationBoundaryInputs.{u})
    (witness : Type u) :
    ∃ promoted : FinalAssemblyPackageBoundaryInputs.{u},
    ∃ minimalInputs : FinalCertificateMinimalPackageInputs.{u},
    ...
    ∃ witnessCriterion : CompletionCriterionAtUniverse witness,
      promoted =
        ...
        checkedCertificate =
          completion_certificate_of_remainingDependencyPackage_and_finalCertificatePrimitiveInputs
            remainingDependencies primitiveInputs ∧
        checkedCertificate =
          completion_certificate_of_remainingDependencyPackage_and_finalCertificatePrimitiveInputs
            (remainingDependencyPackage_of_finalAssemblyPackageBoundaryInputs
              promoted) primitiveInputs ∧
  ...
  let remainingDependencies :=
    remainingDependencyPackage_of_finalAssemblyPackageBoundaryInputs promoted
  let topologyAssemblyPayload :
      FinalCertificateTopologyAssemblyPayload minimalInputs promoted.topology :=
    finalCertificateTopologyAssemblyPayload minimalInputs promoted.topology
  let publicStatement : PoincareConjectureStatement.{u} :=
