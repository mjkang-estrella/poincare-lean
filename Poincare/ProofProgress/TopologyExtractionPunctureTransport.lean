...
two-puncture path/loop package exposes the selected endpoint-data path
directly. This discharges the path-data coherence, endpoint equations,
chosen-path quotient equality, homotopy uniqueness, and loop collapse without
requiring consumers to rewrite through the canonical-path witness.
-/
theorem twoPointComplement_fullChart_endpointData_pathCoherence_loopCollapse_package_of_homeomorph_to_onePoint_threeSpace
    {M : Type u} [TopologicalSpace M]
    (h : Nonempty (M ≃ₜ OnePoint (EuclideanSpace ℝ (Fin 3))))
    {x y : M} (hyx : y ≠ x)
    (basepoint target : (({x} ∪ {y})ᶜ : Set M))
...
-/
theorem twoPointComplement_fullChart_endpointData_pathCoherence_loopCollapse_package_of_homeomorph_to_onePoint_threeSpace_eq :
    @Poincare.twoPointComplement_fullChart_endpointData_pathCoherence_loopCollapse_package_of_homeomorph_to_onePoint_threeSpace =
      @Poincare.twoPointComplement_fullChart_endpointData_pathCoherence_loopCollapse_package_of_homeomorph_to_onePoint_threeSpace :=
  rfl

/--
For a space recognized as a one-point compactification, the full-chart
endpoint-data path/loop package also carries the local path-connectedness of
the transported two-puncture complement.
-/
theorem twoPointComplement_locPath_fullChart_endpointData_pathCoherence_loopCollapse_package_of_homeomorph_to_onePoint_threeSpace
    {M : Type u} [TopologicalSpace M]
    (h : Nonempty (M ≃ₜ OnePoint (EuclideanSpace ℝ (Fin 3))))
    {x y : M} (hyx : y ≠ x)
    (basepoint target : (({x} ∪ {y})ᶜ : Set M))
  ...
  rcases
      twoPointComplement_fullChart_endpointData_pathCoherence_loopCollapse_package_of_homeomorph_to_onePoint_threeSpace
        h hyx basepoint target chosenPath loop with
    ⟨puncture, chart, pathData, endpointData, hAvoid, hNonempty,
      hPathConnected, hConnected, hSimplyConnected, hPathData,
...
-/
theorem twoPointComplement_locPath_fullChart_endpointData_pathCoherence_loopCollapse_package_of_homeomorph_to_onePoint_threeSpace_eq :
    @Poincare.twoPointComplement_locPath_fullChart_endpointData_pathCoherence_loopCollapse_package_of_homeomorph_to_onePoint_threeSpace =
      @Poincare.twoPointComplement_locPath_fullChart_endpointData_pathCoherence_loopCollapse_package_of_homeomorph_to_onePoint_threeSpace :=
  rfl
...
/--
Recognition as a one-point compactification exposes concrete chosen endpoint
data for both the singleton complement and the associated two-puncture
complement while retaining the endpoint-level chart, topology, path-quotient,
and `π₁` collapse payloads.
-/
theorem singletonAndTwoPoint_chosenEndpoint_collapse_package_of_homeomorph_to_onePoint_threeSpace
    {M : Type u} [TopologicalSpace M]
    (h : Nonempty (M ≃ₜ OnePoint (EuclideanSpace ℝ (Fin 3))))
    {x y : M} (hyx : y ≠ x)
    (singleBase singleTarget : ({x}ᶜ : Set M))
  ...
  rcases
      compl_singleton_euclidean_endpoint_collapse_package_of_homeomorph_to_onePoint_threeSpace
        h x singleBase singleTarget with
    ⟨hSingleChart, hSingleContractible, hSinglePathConnected,
      hSingleConnected, hSingleSimplyConnected, hSingleComponent,
      hSingleJoined, hSingleQuotient, hSinglePiOne⟩
  rcases exists_puncture_homeomorph_twoPointComplement_chosenPathTopologyPayload
      h hyx twoBase twoTarget with
    ⟨puncture, chart, twoPathData, twoEndpointData, canonicalPath, hAvoid,
      hTwoNonempty, hTwoPathConnected, hTwoSimplyConnected, hTwoPathData,
      hTwoEndpointPath, hTwoSource, hTwoTarget, hTwoJoined⟩
  rcases twoPointComplement_topology_package_of_homeomorph_to_onePoint_threeSpace
      h hyx with
    ⟨_, _, hTwoConnected, _⟩
  exact
    ⟨⟨singlePathData, singleEndpointData, canonicalSinglePath,
        hSingleChart, hSingleContractible, hSinglePathConnected,
        hSingleConnected, hSingleSimplyConnected, rfl, rfl,
        singleEndpointData.source_eq, singleEndpointData.target_eq,
        hSingleJoined, hSingleComponent, hSingleQuotient, hSinglePiOne⟩,
      ⟨puncture, chart, twoPathData, twoEndpointData, canonicalPath,
        hAvoid, hTwoNonempty, hTwoPathConnected, hTwoConnected,
        hTwoSimplyConnected, hTwoPathData, hTwoEndpointPath, hTwoSource,
        hTwoTarget, hTwoJoined,
        twoPointComplement_pathComponent_eq_univ_of_homeomorph_to_onePoint_threeSpace
          h hyx twoBase,
        twoPointComplement_pathQuotient_subsingleton_of_homeomorph_to_onePoint_threeSpace
          h hyx twoBase twoTarget,
...
-/
theorem singletonAndTwoPoint_chosenEndpoint_collapse_package_of_homeomorph_to_onePoint_threeSpace_eq :
    @Poincare.singletonAndTwoPoint_chosenEndpoint_collapse_package_of_homeomorph_to_onePoint_threeSpace =
      @Poincare.singletonAndTwoPoint_chosenEndpoint_collapse_package_of_homeomorph_to_onePoint_threeSpace :=
  rfl
...
/--
The singleton/two-puncture endpoint loop-collapse package projects to a compact
homotopy core on both puncture surfaces.  This keeps the endpoint-data path
coherence, endpoint equations, path-component collapse, path-quotient
subsingleton, loop null-homotopy, fundamental-group equality, and `π₁`
subsingleton evidence, without exposing the Euclidean chart payloads.
-/
theorem singletonAndTwoPoint_endpointData_loopCollapse_core_of_homeomorph_to_onePoint_threeSpace
    {M : Type u} [TopologicalSpace M]
    (h : Nonempty (M ≃ₜ OnePoint (EuclideanSpace ℝ (Fin 3))))
    {x y : M} (hyx : y ≠ x)
    (singleBase singleTarget : ({x}ᶜ : Set M))
    ...
    (∃ singlePathData :
      ...
      ∃ singleEndpointData :
        ...
        singlePathData.path_to singleTarget = singleEndpointData.path ∧
          ...
          Subsingleton (HomotopyGroup.Pi 1 ({x}ᶜ : Set M) singleBase)) ∧
      ∃ twoPathData : PointedPathComponentPathData C twoBase,
        ∃ twoEndpointData : PointedChosenPathEndpointData C twoBase twoTarget,
  ...
  rcases
      singletonAndTwoPoint_chosenEndpoint_loopCollapse_package_of_homeomorph_to_onePoint_threeSpace
        h hyx singleBase singleTarget singleLoop twoBase twoTarget twoLoop with
    ⟨hSingle, hTwo⟩
  rcases hSingle with
    ⟨singlePathData, singleEndpointData, _canonicalSinglePath,
      _hSingleChart, _hSingleContractible, _hSinglePathConnected,
      _hSingleConnected, _hSingleSimplyConnected, hSinglePathData,
      hSingleEndpoint, hSingleSource, hSingleTarget, hSingleJoined,
      hSingleComponent, hSingleQuotient, hSingleLoopSource,
      hSingleLoopTarget, hSingleLoopHomotopic, hSingleLoopFromPath,
      hSinglePiOne⟩
  rcases hTwo with
    ⟨_puncture, _chart, twoPathData, twoEndpointData, _canonicalPath,
      _hAvoid, _hTwoNonempty, _hTwoPathConnected, _hTwoConnected,
      _hTwoSimplyConnected, hTwoPathData, hTwoEndpoint, hTwoSource,
      hTwoTarget, hTwoJoined, hTwoComponent, hTwoQuotient,
      hTwoLoopSource, hTwoLoopTarget, hTwoLoopHomotopic, hTwoLoopFromPath,
      hTwoPiOne⟩
  exact
    ⟨⟨singlePathData, singleEndpointData,
        hSinglePathData.trans hSingleEndpoint.symm,
        by simp [hSingleEndpoint, hSingleSource],
        by simp [hSingleEndpoint, hSingleTarget],
        hSingleJoined, hSingleComponent, hSingleQuotient, hSingleLoopSource,
        hSingleLoopTarget, hSingleLoopHomotopic, hSingleLoopFromPath,
        hSinglePiOne⟩,
      twoPathData, twoEndpointData, hTwoPathData.trans hTwoEndpoint.symm,
      by simpa [hTwoEndpoint] using hTwoSource,
      by simpa [hTwoEndpoint] using hTwoTarget,
      hTwoJoined, hTwoComponent, hTwoQuotient,
      hTwoLoopSource, hTwoLoopTarget, hTwoLoopHomotopic, hTwoLoopFromPath,
      hTwoPiOne⟩
...
-/
theorem singletonAndTwoPoint_endpointData_loopCollapse_core_of_homeomorph_to_onePoint_threeSpace_eq :
    @Poincare.singletonAndTwoPoint_endpointData_loopCollapse_core_of_homeomorph_to_onePoint_threeSpace =
      @Poincare.singletonAndTwoPoint_endpointData_loopCollapse_core_of_homeomorph_to_onePoint_threeSpace :=
  rfl
...
collapse data on both puncture surfaces.
-/
theorem singletonAndTwoPoint_canonicalPath_loopCollapse_package_of_homeomorph_to_onePoint_threeSpace
    {M : Type u} [TopologicalSpace M]
    (h : Nonempty (M ≃ₜ OnePoint (EuclideanSpace ℝ (Fin 3))))
    {x y : M} (hyx : y ≠ x)
    (singleBase singleTarget : ({x}ᶜ : Set M))
  ...
  exact
    ⟨⟨singlePathData, singleEndpointData, canonicalSinglePath,
      ...
      ⟨puncture, chart, twoPathData, twoEndpointData, canonicalPath,
        hAvoid, hTwoNonempty, hTwoPathConnected, hTwoConnected,
        hTwoSimplyConnected, hTwoPathData, hTwoEndpoint, hTwoSource,
        hTwoTarget, hTwoJoined, hTwoComponent,
        fun η =>
          twoPointComplement_paths_homotopic_of_homeomorph_to_onePoint_threeSpace
            h hyx canonicalPath η,
...
/--
Theorem contract for
`singletonAndTwoPoint_canonicalPath_loopCollapse_package_of_homeomorph_to_onePoint_threeSpace`.
-/
theorem singletonAndTwoPoint_canonicalPath_loopCollapse_package_of_homeomorph_to_onePoint_threeSpace_eq :
    @Poincare.singletonAndTwoPoint_canonicalPath_loopCollapse_package_of_homeomorph_to_onePoint_threeSpace =
      @Poincare.singletonAndTwoPoint_canonicalPath_loopCollapse_package_of_homeomorph_to_onePoint_threeSpace :=
  rfl

/--
The singleton/two-puncture canonical-path loop-collapse package projects to a
compact core on both puncture surfaces.  This keeps the endpoint-data path
coherence, endpoint equations, path-component collapse, canonical path
homotopy uniqueness, path-quotient subsingletons, loop null-homotopies,
fundamental-group equalities, and `π₁` subsingletons, without exposing the
Euclidean chart payloads.
-/
theorem singletonAndTwoPoint_canonicalPath_loopCollapse_core_of_homeomorph_to_onePoint_threeSpace
    {M : Type u} [TopologicalSpace M]
    (h : Nonempty (M ≃ₜ OnePoint (EuclideanSpace ℝ (Fin 3))))
    {x y : M} (hyx : y ≠ x)
    (singleBase singleTarget : ({x}ᶜ : Set M))
  ...
  rcases hSingle with
    ⟨singlePathData, singleEndpointData, canonicalSinglePath,
      ...
      _hSingleConnected, _hSingleSimplyConnected, hSinglePathData,
      hSingleEndpoint, hSingleSource, hSingleTarget, hSingleJoined,
      hSingleComponent, hSingleCanonical, hSingleQuotient,
      hSingleLoopSource, hSingleLoopTarget, hSingleLoopHomotopic,
      hSingleLoopFromPath, hSinglePiOne⟩
  rcases hTwo with
    ⟨_puncture, _chart, twoPathData, twoEndpointData, canonicalPath,
      _hAvoid, _hTwoNonempty, _hTwoPathConnected, _hTwoConnected,
      _hTwoSimplyConnected, hTwoPathData, hTwoEndpoint, hTwoSource,
      hTwoTarget, hTwoJoined, hTwoComponent, hTwoCanonical, hTwoQuotient,
      hTwoLoopSource, hTwoLoopTarget, hTwoLoopHomotopic, hTwoLoopFromPath,
      hTwoPiOne⟩
  exact
    ⟨⟨singlePathData, singleEndpointData, canonicalSinglePath,
        hSinglePathData, hSingleEndpoint, hSingleSource, hSingleTarget,
        hSingleJoined, hSingleComponent, hSingleCanonical,
        hSingleQuotient, hSingleLoopSource, hSingleLoopTarget,
        hSingleLoopHomotopic, hSingleLoopFromPath, hSinglePiOne⟩,
      twoPathData, twoEndpointData, canonicalPath, hTwoPathData,
      hTwoEndpoint, hTwoSource, hTwoTarget, hTwoJoined, hTwoComponent,
      hTwoCanonical, hTwoQuotient, hTwoLoopSource, hTwoLoopTarget,
      hTwoLoopHomotopic, hTwoLoopFromPath, hTwoPiOne⟩

/--
Theorem contract for
`singletonAndTwoPoint_canonicalPath_loopCollapse_core_of_homeomorph_to_onePoint_threeSpace`.
-/
theorem singletonAndTwoPoint_canonicalPath_loopCollapse_core_of_homeomorph_to_onePoint_threeSpace_eq :
    @Poincare.singletonAndTwoPoint_canonicalPath_loopCollapse_core_of_homeomorph_to_onePoint_threeSpace =
      @Poincare.singletonAndTwoPoint_canonicalPath_loopCollapse_core_of_homeomorph_to_onePoint_threeSpace :=
  rfl
...
/--
Recognition as a one-point compactification exposes singleton path/loop
collapse together with a full-topology two-puncture chosen path/loop
projection payload.
-/
theorem singletonPathLoop_and_twoPointFullTopologyChosenPathLoopProjection_of_homeomorph_to_onePoint_threeSpace
    {M : Type u} [TopologicalSpace M]
    (h : Nonempty (M ≃ₜ OnePoint (EuclideanSpace ℝ (Fin 3))))
    {x y : M} (hyx : y ≠ x)
    {a b : ({x}ᶜ : Set M)} (γ η : Path a b)
  ...
  rcases
      singletonPathLoop_and_twoPointChartPathLoopProjection_of_homeomorph_to_onePoint_threeSpace
        h hyx γ η singleBase singleLoop twoBase twoTarget chosenPath loop with
    ⟨hSingleHomotopy, hSingleQuotient, hSingleLoopSource,
      hSingleLoopTarget, hSingleLoopHomotopic, hSingleLoopFromPath,
      hSinglePiOne, _twoPayload⟩
  exact
    ⟨hSingleHomotopy, hSingleQuotient, hSingleLoopSource,
      hSingleLoopTarget, hSingleLoopHomotopic, hSingleLoopFromPath,
      hSinglePiOne,
...
/--
Theorem contract for
`singletonPathLoop_and_twoPointFullTopologyChosenPathLoopProjection_of_homeomorph_to_onePoint_threeSpace`.
-/
theorem singletonPathLoop_and_twoPointFullTopologyChosenPathLoopProjection_of_homeomorph_to_onePoint_threeSpace_eq :
    @Poincare.singletonPathLoop_and_twoPointFullTopologyChosenPathLoopProjection_of_homeomorph_to_onePoint_threeSpace =
      @Poincare.singletonPathLoop_and_twoPointFullTopologyChosenPathLoopProjection_of_homeomorph_to_onePoint_threeSpace :=
  rfl

/--
Recognition as a one-point compactification exposes singleton-complement
path/loop collapse together with the full two-puncture chart/path-loop
projection payload, including connectedness of the two-puncture complement.
-/
theorem singletonPathLoop_and_twoPointFullChartPathLoopProjection_of_homeomorph_to_onePoint_threeSpace
    {M : Type u} [TopologicalSpace M]
    (h : Nonempty (M ≃ₜ OnePoint (EuclideanSpace ℝ (Fin 3))))
    {x y : M} (hyx : y ≠ x)
    {a b : ({x}ᶜ : Set M)} (γ η : Path a b)
    ...
    Path.Homotopic γ η ∧
      ...
      ∃ puncture : EuclideanSpace ℝ (Fin 3),
        ∃ chart : C ≃ₜ ({puncture}ᶜ : Set (EuclideanSpace ℝ (Fin 3))),
          ∃ pathData : PointedPathComponentPathData C twoBase,
            ∃ endpointData : PointedChosenPathEndpointData C twoBase twoTarget,
              ∃ canonicalPath : Path twoBase twoTarget,
                (∀ w, (chart w : EuclideanSpace ℝ (Fin 3)) ≠ puncture) ∧
                  Nonempty C ∧
                  PathConnectedSpace C ∧
...
/--
Theorem contract for
`singletonPathLoop_and_twoPointFullChartPathLoopProjection_of_homeomorph_to_onePoint_threeSpace`.
-/
theorem singletonPathLoop_and_twoPointFullChartPathLoopProjection_of_homeomorph_to_onePoint_threeSpace_eq :
    @Poincare.singletonPathLoop_and_twoPointFullChartPathLoopProjection_of_homeomorph_to_onePoint_threeSpace =
      @Poincare.singletonPathLoop_and_twoPointFullChartPathLoopProjection_of_homeomorph_to_onePoint_threeSpace :=
  rfl
...
/--
Recognition as a one-point compactification exposes explicit singleton
chosen-path endpoint data together with singleton path/loop collapse and a
full-topology two-puncture chosen path/loop projection payload.
-/
theorem singletonChosenPathLoop_and_twoPointFullTopologyChosenPathLoopProjection_of_homeomorph_to_onePoint_threeSpace
    {M : Type u} [TopologicalSpace M]
    (h : Nonempty (M ≃ₜ OnePoint (EuclideanSpace ℝ (Fin 3))))
    {x y : M} (hyx : y ≠ x)
    (singleBase singleTarget : ({x}ᶜ : Set M))
  ...
  rcases
      singletonChosenPathLoop_and_twoPointChartPathLoopProjection_of_homeomorph_to_onePoint_threeSpace
        ...
        twoBase twoTarget chosenPath loop with
    ⟨singlePathData, singleEndpointData, canonicalSinglePath, hSinglePathData,
      hSingleEndpoint, hSingleSource, hSingleTarget, hSingleJoined,
      hSingleComponent, hChosenSingle, hChosenSingleQuotient, hSingleUnique,
      hSingleQuotientSubsingleton, hSingleLoopSource, hSingleLoopTarget,
      hSingleLoopHomotopic, hSingleLoopFromPath, hSinglePiOne, _twoPayload⟩
  exact
    ⟨singlePathData, singleEndpointData, canonicalSinglePath, hSinglePathData,
      hSingleEndpoint, hSingleSource, hSingleTarget, hSingleJoined,
      hSingleComponent, hChosenSingle, hChosenSingleQuotient, hSingleUnique,
...
/--
Theorem contract for
`singletonChosenPathLoop_and_twoPointFullTopologyChosenPathLoopProjection_of_homeomorph_to_onePoint_threeSpace`.
-/
theorem singletonChosenPathLoop_and_twoPointFullTopologyChosenPathLoopProjection_of_homeomorph_to_onePoint_threeSpace_eq :
    @Poincare.singletonChosenPathLoop_and_twoPointFullTopologyChosenPathLoopProjection_of_homeomorph_to_onePoint_threeSpace =
      @Poincare.singletonChosenPathLoop_and_twoPointFullTopologyChosenPathLoopProjection_of_homeomorph_to_onePoint_threeSpace :=
  rfl
...
Recognition as a one-point compactification exposes explicit singleton
chosen-path endpoint data together with singleton path/loop collapse and the
full two-puncture chart/path-loop projection payload.
-/
theorem singletonChosenPathLoop_and_twoPointFullChartPathLoopProjection_of_homeomorph_to_onePoint_threeSpace
    {M : Type u} [TopologicalSpace M]
    (h : Nonempty (M ≃ₜ OnePoint (EuclideanSpace ℝ (Fin 3))))
    {x y : M} (hyx : y ≠ x)
    (singleBase singleTarget : ({x}ᶜ : Set M))
...
/--
Theorem contract for
`singletonChosenPathLoop_and_twoPointFullChartPathLoopProjection_of_homeomorph_to_onePoint_threeSpace`.
-/
theorem singletonChosenPathLoop_and_twoPointFullChartPathLoopProjection_of_homeomorph_to_onePoint_threeSpace_eq :
    @Poincare.singletonChosenPathLoop_and_twoPointFullChartPathLoopProjection_of_homeomorph_to_onePoint_threeSpace =
      @Poincare.singletonChosenPathLoop_and_twoPointFullChartPathLoopProjection_of_homeomorph_to_onePoint_threeSpace :=
  rfl

/--
Recognition as a one-point compactification exposes the singleton and
two-puncture endpoint-data paths directly in the full-chart path/loop package.
Both selected endpoint paths carry their endpoint equations, path-data
coherence, chosen-path quotient collapse, homotopy uniqueness, and loop
collapse without requiring consumers to rewrite through canonical-path
witnesses.
-/
theorem singletonChosenPathLoop_and_twoPointFullChartEndpointDataPathCoherence_of_homeomorph_to_onePoint_threeSpace
    {M : Type u} [TopologicalSpace M]
    (h : Nonempty (M ≃ₜ OnePoint (EuclideanSpace ℝ (Fin 3))))
    {x y : M} (hyx : y ≠ x)
    (singleBase singleTarget : ({x}ᶜ : Set M))
  ...
  rcases
      singletonChosenPathLoop_and_twoPointFullChartPathLoopProjection_of_homeomorph_to_onePoint_threeSpace
        ...
        twoBase twoTarget chosenPath loop with
    ⟨singlePathData, singleEndpointData, canonicalSinglePath,
      hSinglePathData, hSingleEndpointData, hSingleSource, hSingleTarget,
      hSingleJoined, hSingleComponent, hSingleChosenHomotopic,
      hSingleChosenQuotient, hSingleUnique, hSingleQuotientSubsingleton,
      hSingleLoopSource, hSingleLoopTarget, hSingleLoopHomotopic,
      hSingleLoopFromPath, hSinglePiOne, puncture, chart, twoPathData,
      twoEndpointData, canonicalPath, hAvoid, hNonempty, hPathConnected,
      hConnected, hSimplyConnected, hTwoPathData, hTwoEndpointData,
      hTwoSource, hTwoTarget, hTwoJoined, hTwoComponent,
      hTwoChosenHomotopic, hTwoChosenQuotient, hTwoUnique,
      hTwoQuotientSubsingleton, hLoopSource, hLoopTarget, hLoopHomotopic,
      hLoopFromPath, hPiOne⟩
  exact
    ⟨singlePathData, singleEndpointData,
      hSinglePathData.trans hSingleEndpointData.symm,
      by simp [hSingleEndpointData, hSingleSource],
      by simp [hSingleEndpointData, hSingleTarget],
      hSingleJoined, hSingleComponent,
      by simpa [hSingleEndpointData] using hSingleChosenHomotopic,
      by simpa [hSingleEndpointData] using hSingleChosenQuotient,
      by
        intro ζ
        simpa [hSingleEndpointData] using hSingleUnique ζ,
      hSingleQuotientSubsingleton, hSingleLoopSource, hSingleLoopTarget,
      hSingleLoopHomotopic, hSingleLoopFromPath, hSinglePiOne,
      puncture, chart, twoPathData, twoEndpointData, hAvoid, hNonempty,
      hPathConnected, hConnected, hSimplyConnected,
      hTwoPathData.trans hTwoEndpointData.symm,
      by simpa [hTwoEndpointData] using hTwoSource,
      by simpa [hTwoEndpointData] using hTwoTarget,
      hTwoJoined, hTwoComponent,
      by simpa [hTwoEndpointData] using hTwoChosenHomotopic,
      by simpa [hTwoEndpointData] using hTwoChosenQuotient,
      by
        intro ζ
        simpa [hTwoEndpointData] using hTwoUnique ζ,
      hTwoQuotientSubsingleton, hLoopSource, hLoopTarget, hLoopHomotopic,
      hLoopFromPath, hPiOne⟩
...
-/
theorem singletonChosenPathLoop_and_twoPointFullChartEndpointDataPathCoherence_of_homeomorph_to_onePoint_threeSpace_eq :
    @Poincare.singletonChosenPathLoop_and_twoPointFullChartEndpointDataPathCoherence_of_homeomorph_to_onePoint_threeSpace =
      @Poincare.singletonChosenPathLoop_and_twoPointFullChartEndpointDataPathCoherence_of_homeomorph_to_onePoint_threeSpace :=
  rfl

/--
The singleton/two-puncture full-chart endpoint-data path-coherence package
projects to the chosen-path homotopy core on both puncture surfaces.  This
core keeps the supplied chosen-path homotopies and quotient equalities, the
universal endpoint-path homotopies, loop null-homotopies, fundamental-group
equalities, and `π₁` subsingletons, while omitting chart and connectedness
payloads.
-/
theorem singletonChosenPathLoop_and_twoPointEndpointDataPathCoherence_core_of_homeomorph_to_onePoint_threeSpace
    {M : Type u} [TopologicalSpace M]
    (h : Nonempty (M ≃ₜ OnePoint (EuclideanSpace ℝ (Fin 3))))
    {x y : M} (hyx : y ≠ x)
    (singleBase singleTarget : ({x}ᶜ : Set M))
  ...
  rcases
    ...
    ⟨singlePathData, singleEndpointData, hSinglePathData,
      ...
      hSingleChosenHomotopic, hSingleChosenQuotient, hSingleUnique,
      hSingleQuotientSubsingleton, hSingleLoopSource, hSingleLoopTarget,
      hSingleLoopHomotopic, hSingleLoopFromPath, hSinglePiOne, hTwo⟩
  rcases hTwo with
    ⟨_puncture, _chart, twoPathData, twoEndpointData, _hAvoid,
      _hNonempty, _hPathConnected, _hConnected, _hSimplyConnected,
      hTwoPathData, hTwoSource, hTwoTarget, hTwoJoined, hTwoComponent,
      hTwoChosenHomotopic, hTwoChosenQuotient, hTwoUnique,
      hTwoQuotientSubsingleton, hLoopSource, hLoopTarget, hLoopHomotopic,
      hLoopFromPath, hPiOne⟩
  exact
    ⟨singlePathData, singleEndpointData, hSinglePathData, hSingleSource,
      hSingleTarget, hSingleJoined, hSingleComponent,
      hSingleChosenHomotopic, hSingleChosenQuotient, hSingleUnique,
      hSingleQuotientSubsingleton, hSingleLoopSource, hSingleLoopTarget,
      hSingleLoopHomotopic, hSingleLoopFromPath, hSinglePiOne,
      twoPathData, twoEndpointData, hTwoPathData, hTwoSource, hTwoTarget,
      hTwoJoined, hTwoComponent, hTwoChosenHomotopic, hTwoChosenQuotient,
      hTwoUnique, hTwoQuotientSubsingleton, hLoopSource, hLoopTarget,
      hLoopHomotopic, hLoopFromPath, hPiOne⟩

/--
Theorem contract for
`singletonChosenPathLoop_and_twoPointEndpointDataPathCoherence_core_of_homeomorph_to_onePoint_threeSpace`.
-/
theorem singletonChosenPathLoop_and_twoPointEndpointDataPathCoherence_core_of_homeomorph_to_onePoint_threeSpace_eq :
    @Poincare.singletonChosenPathLoop_and_twoPointEndpointDataPathCoherence_core_of_homeomorph_to_onePoint_threeSpace =
      @Poincare.singletonChosenPathLoop_and_twoPointEndpointDataPathCoherence_core_of_homeomorph_to_onePoint_threeSpace :=
  rfl
...
Recognition as a one-point compactification gives the actual Euclidean chart
on a singleton complement together with explicit singleton chosen-path data
and a full-topology two-puncture chosen path/loop projection payload.
-/
theorem singletonEuclideanChart_chosenPathLoop_and_twoPointFullTopologyChosenPathLoopProjection_of_homeomorph_to_onePoint_threeSpace
    {M : Type u} [TopologicalSpace M]
    (h : Nonempty (M ≃ₜ OnePoint (EuclideanSpace ℝ (Fin 3))))
    {x y : M} (hyx : y ≠ x)
    (singleBase singleTarget : ({x}ᶜ : Set M))
...
/--
Theorem contract for
`singletonEuclideanChart_chosenPathLoop_and_twoPointFullTopologyChosenPathLoopProjection_of_homeomorph_to_onePoint_threeSpace`.
-/
theorem singletonEuclideanChart_chosenPathLoop_and_twoPointFullTopologyChosenPathLoopProjection_of_homeomorph_to_onePoint_threeSpace_eq :
    @Poincare.singletonEuclideanChart_chosenPathLoop_and_twoPointFullTopologyChosenPathLoopProjection_of_homeomorph_to_onePoint_threeSpace =
      @Poincare.singletonEuclideanChart_chosenPathLoop_and_twoPointFullTopologyChosenPathLoopProjection_of_homeomorph_to_onePoint_threeSpace :=
  rfl
...
Recognition as a one-point compactification gives the actual Euclidean chart
on a singleton complement together with explicit singleton chosen-path data,
singleton path/loop collapse, and the full two-puncture chart/path-loop
projection payload.
-/
theorem singletonEuclideanChart_chosenPathLoop_and_twoPointFullChartPathLoopProjection_of_homeomorph_to_onePoint_threeSpace
    {M : Type u} [TopologicalSpace M]
    (h : Nonempty (M ≃ₜ OnePoint (EuclideanSpace ℝ (Fin 3))))
    {x y : M} (hyx : y ≠ x)
    (singleBase singleTarget : ({x}ᶜ : Set M))
...
/--
Theorem contract for
`singletonEuclideanChart_chosenPathLoop_and_twoPointFullChartPathLoopProjection_of_homeomorph_to_onePoint_threeSpace`.
-/
theorem singletonEuclideanChart_chosenPathLoop_and_twoPointFullChartPathLoopProjection_of_homeomorph_to_onePoint_threeSpace_eq :
    @Poincare.singletonEuclideanChart_chosenPathLoop_and_twoPointFullChartPathLoopProjection_of_homeomorph_to_onePoint_threeSpace =
      @Poincare.singletonEuclideanChart_chosenPathLoop_and_twoPointFullChartPathLoopProjection_of_homeomorph_to_onePoint_threeSpace :=
  rfl
...
/--
Recognition as a one-point compactification supplies the singleton Euclidean
chart and direct endpoint-data path coherence together with local
path-connectedness of the two-puncture complement.
-/
theorem singletonEuclideanChart_chosenPathLoop_and_twoPointLocPathFullChartEndpointDataPathCoherence_of_homeomorph_to_onePoint_threeSpace
    {M : Type u} [TopologicalSpace M]
    (h : Nonempty (M ≃ₜ OnePoint (EuclideanSpace ℝ (Fin 3))))
    {x y : M} (hyx : y ≠ x)
    (singleBase singleTarget : ({x}ᶜ : Set M))
...
/--
Theorem contract for
`singletonEuclideanChart_chosenPathLoop_and_twoPointLocPathFullChartEndpointDataPathCoherence_of_homeomorph_to_onePoint_threeSpace`.
-/
theorem singletonEuclideanChart_chosenPathLoop_and_twoPointLocPathFullChartEndpointDataPathCoherence_of_homeomorph_to_onePoint_threeSpace_eq :
    @Poincare.singletonEuclideanChart_chosenPathLoop_and_twoPointLocPathFullChartEndpointDataPathCoherence_of_homeomorph_to_onePoint_threeSpace =
      @Poincare.singletonEuclideanChart_chosenPathLoop_and_twoPointLocPathFullChartEndpointDataPathCoherence_of_homeomorph_to_onePoint_threeSpace :=
  rfl
...
Euclidean chart and path/loop projection payload are available with the full
topology package, including connectedness of the complement.
-/
theorem twoPointComplement_fullChart_path_loop_projection_bundle_of_homeomorph_to_threeSphere
    {M : Type u} [TopologicalSpace M]
    (h : Nonempty (M ≃ₜ ThreeSphere)) {x y : M} (hyx : y ≠ x)
    (basepoint target : (({x} ∪ {y})ᶜ : Set M))
    (chosenPath : Path basepoint target)
                ...
                FundamentalGroup.fromPath
                  ...
                  FundamentalGroup.fromPath
                    (⟦Path.refl basepoint⟧ :
                      Path.Homotopic.Quotient basepoint basepoint) ∧
                Subsingleton
                  (HomotopyGroup.Pi 1 C basepoint) :=
  twoPointComplement_fullChart_path_loop_projection_bundle_of_homeomorph_to_onePoint_threeSpace
    (homeomorph_to_onePoint_threeSpace_of_homeomorph_to_threeSphere h) hyx
    basepoint target chosenPath loop
...
/--
Theorem contract for
`twoPointComplement_fullChart_path_loop_projection_bundle_of_homeomorph_to_threeSphere`.
-/
...
/--
For a space recognized as `ThreeSphere`, the full-chart two-puncture
path/loop package exposes the selected endpoint-data path directly, including
path-data coherence, endpoint equations, chosen-path quotient equality,
homotopy uniqueness, and loop collapse.
-/
theorem twoPointComplement_fullChart_endpointData_pathCoherence_loopCollapse_package_of_homeomorph_to_threeSphere
    {M : Type u} [TopologicalSpace M]
    (h : Nonempty (M ≃ₜ ThreeSphere)) {x y : M} (hyx : y ≠ x)
    (basepoint target : (({x} ∪ {y})ᶜ : Set M))
    (chosenPath : Path basepoint target)
...
/--
Theorem contract for
`twoPointComplement_fullChart_endpointData_pathCoherence_loopCollapse_package_of_homeomorph_to_threeSphere`.
-/
...
/--
For a space recognized as `ThreeSphere`, the full-chart endpoint-data
path/loop package also carries the transported local path-connectedness
instance for the two-puncture complement.
-/
theorem twoPointComplement_locPath_fullChart_endpointData_pathCoherence_loopCollapse_package_of_homeomorph_to_threeSphere
    {M : Type u} [TopologicalSpace M]
    (h : Nonempty (M ≃ₜ ThreeSphere)) {x y : M} (hyx : y ≠ x)
    (basepoint target : (({x} ∪ {y})ᶜ : Set M))
    (chosenPath : Path basepoint target)
...
/--
Theorem contract for
`twoPointComplement_locPath_fullChart_endpointData_pathCoherence_loopCollapse_package_of_homeomorph_to_threeSphere`.
-/
theorem twoPointComplement_locPath_fullChart_endpointData_pathCoherence_loopCollapse_package_of_homeomorph_to_threeSphere_eq :
    @Poincare.twoPointComplement_locPath_fullChart_endpointData_pathCoherence_loopCollapse_package_of_homeomorph_to_threeSphere =
      @Poincare.twoPointComplement_locPath_fullChart_endpointData_pathCoherence_loopCollapse_package_of_homeomorph_to_threeSphere :=
  rfl
...
/--
Recognition as `ThreeSphere` exposes concrete chosen endpoint data for both
the singleton complement and the associated two-puncture complement while
retaining the endpoint-level chart, topology, path-quotient, and `π₁` collapse
payloads.
-/
theorem singletonAndTwoPoint_chosenEndpoint_collapse_package_of_homeomorph_to_threeSphere
    {M : Type u} [TopologicalSpace M]
    (h : Nonempty (M ≃ₜ ThreeSphere)) {x y : M} (hyx : y ≠ x)
    (singleBase singleTarget : ({x}ᶜ : Set M))
    (twoBase twoTarget : (({x} ∪ {y})ᶜ : Set M)) :
...
/--
Theorem contract for
`singletonAndTwoPoint_chosenEndpoint_collapse_package_of_homeomorph_to_threeSphere`.
-/
...
/--
Recognition as `ThreeSphere` exposes canonical endpoint paths for the
singleton and two-puncture complements, proves those canonical paths are
homotopic to every same-endpoint path, and keeps the supplied based-loop
collapse data on both puncture surfaces.
-/
theorem singletonAndTwoPoint_canonicalPath_loopCollapse_package_of_homeomorph_to_threeSphere
    {M : Type u} [TopologicalSpace M]
    (h : Nonempty (M ≃ₜ ThreeSphere)) {x y : M} (hyx : y ≠ x)
    (singleBase singleTarget : ({x}ᶜ : Set M))
    (singleLoop : Path singleBase singleBase)
...
/--
Theorem contract for
`singletonAndTwoPoint_canonicalPath_loopCollapse_package_of_homeomorph_to_threeSphere`.
-/
theorem singletonAndTwoPoint_canonicalPath_loopCollapse_package_of_homeomorph_to_threeSphere_eq :
    @Poincare.singletonAndTwoPoint_canonicalPath_loopCollapse_package_of_homeomorph_to_threeSphere =
      @Poincare.singletonAndTwoPoint_canonicalPath_loopCollapse_package_of_homeomorph_to_threeSphere :=
  rfl

/--
Recognition as `ThreeSphere` projects the singleton/two-puncture
canonical-path loop-collapse package to the compact core used by the one-point
compactification route.
-/
theorem singletonAndTwoPoint_canonicalPath_loopCollapse_core_of_homeomorph_to_threeSphere
    {M : Type u} [TopologicalSpace M]
    (h : Nonempty (M ≃ₜ ThreeSphere)) {x y : M} (hyx : y ≠ x)
    (singleBase singleTarget : ({x}ᶜ : Set M))
    (singleLoop : Path singleBase singleBase)
...
/--
Theorem contract for
`singletonAndTwoPoint_canonicalPath_loopCollapse_core_of_homeomorph_to_threeSphere`.
-/
theorem singletonAndTwoPoint_canonicalPath_loopCollapse_core_of_homeomorph_to_threeSphere_eq :
    @Poincare.singletonAndTwoPoint_canonicalPath_loopCollapse_core_of_homeomorph_to_threeSphere =
      @Poincare.singletonAndTwoPoint_canonicalPath_loopCollapse_core_of_homeomorph_to_threeSphere :=
  rfl
...
/--
Recognition as `ThreeSphere` exposes singleton path/loop collapse together
with a full-topology two-puncture chosen path/loop projection payload.
-/
theorem singletonPathLoop_and_twoPointFullTopologyChosenPathLoopProjection_of_homeomorph_to_threeSphere
    {M : Type u} [TopologicalSpace M]
    (h : Nonempty (M ≃ₜ ThreeSphere)) {x y : M} (hyx : y ≠ x)
    {a b : ({x}ᶜ : Set M)} (γ η : Path a b)
    (singleBase : ({x}ᶜ : Set M))
...
/--
Theorem contract for
`singletonPathLoop_and_twoPointFullTopologyChosenPathLoopProjection_of_homeomorph_to_threeSphere`.
-/
theorem singletonPathLoop_and_twoPointFullTopologyChosenPathLoopProjection_of_homeomorph_to_threeSphere_eq :
    @Poincare.singletonPathLoop_and_twoPointFullTopologyChosenPathLoopProjection_of_homeomorph_to_threeSphere =
      @Poincare.singletonPathLoop_and_twoPointFullTopologyChosenPathLoopProjection_of_homeomorph_to_threeSphere :=
  rfl

/--
Recognition as `ThreeSphere` exposes singleton-complement path/loop collapse
together with the full two-puncture chart/path-loop projection payload,
including connectedness of the two-puncture complement.
-/
theorem singletonPathLoop_and_twoPointFullChartPathLoopProjection_of_homeomorph_to_threeSphere
    {M : Type u} [TopologicalSpace M]
    (h : Nonempty (M ≃ₜ ThreeSphere)) {x y : M} (hyx : y ≠ x)
    {a b : ({x}ᶜ : Set M)} (γ η : Path a b)
    (singleBase : ({x}ᶜ : Set M))
...
/--
Theorem contract for
`singletonPathLoop_and_twoPointFullChartPathLoopProjection_of_homeomorph_to_threeSphere`.
-/
theorem singletonPathLoop_and_twoPointFullChartPathLoopProjection_of_homeomorph_to_threeSphere_eq :
    @Poincare.singletonPathLoop_and_twoPointFullChartPathLoopProjection_of_homeomorph_to_threeSphere =
      @Poincare.singletonPathLoop_and_twoPointFullChartPathLoopProjection_of_homeomorph_to_threeSphere :=
  rfl
...
/--
Recognition as `ThreeSphere` exposes explicit singleton chosen-path endpoint
data together with singleton path/loop collapse and a full-topology
two-puncture chosen path/loop projection payload.
-/
theorem singletonChosenPathLoop_and_twoPointFullTopologyChosenPathLoopProjection_of_homeomorph_to_threeSphere
    {M : Type u} [TopologicalSpace M]
    (h : Nonempty (M ≃ₜ ThreeSphere)) {x y : M} (hyx : y ≠ x)
    (singleBase singleTarget : ({x}ᶜ : Set M))
    (chosenSinglePath : Path singleBase singleTarget)
...
/--
Theorem contract for
`singletonChosenPathLoop_and_twoPointFullTopologyChosenPathLoopProjection_of_homeomorph_to_threeSphere`.
-/
theorem singletonChosenPathLoop_and_twoPointFullTopologyChosenPathLoopProjection_of_homeomorph_to_threeSphere_eq :
    @Poincare.singletonChosenPathLoop_and_twoPointFullTopologyChosenPathLoopProjection_of_homeomorph_to_threeSphere =
      @Poincare.singletonChosenPathLoop_and_twoPointFullTopologyChosenPathLoopProjection_of_homeomorph_to_threeSphere :=
  rfl

/--
Recognition as `ThreeSphere` exposes explicit singleton chosen-path endpoint
data together with singleton path/loop collapse and the full two-puncture
chart/path-loop projection payload.
-/
theorem singletonChosenPathLoop_and_twoPointFullChartPathLoopProjection_of_homeomorph_to_threeSphere
    {M : Type u} [TopologicalSpace M]
    (h : Nonempty (M ≃ₜ ThreeSphere)) {x y : M} (hyx : y ≠ x)
    (singleBase singleTarget : ({x}ᶜ : Set M))
    (chosenSinglePath : Path singleBase singleTarget)
...
/--
Theorem contract for
`singletonChosenPathLoop_and_twoPointFullChartPathLoopProjection_of_homeomorph_to_threeSphere`.
-/
theorem singletonChosenPathLoop_and_twoPointFullChartPathLoopProjection_of_homeomorph_to_threeSphere_eq :
    @Poincare.singletonChosenPathLoop_and_twoPointFullChartPathLoopProjection_of_homeomorph_to_threeSphere =
      @Poincare.singletonChosenPathLoop_and_twoPointFullChartPathLoopProjection_of_homeomorph_to_threeSphere :=
  rfl

/--
Recognition as `ThreeSphere` exposes the singleton and two-puncture
endpoint-data paths directly in the full-chart path/loop package. This is the
`ThreeSphere` recognition form of the endpoint-data coherence payload for both
selected paths.
-/
theorem singletonChosenPathLoop_and_twoPointFullChartEndpointDataPathCoherence_of_homeomorph_to_threeSphere
    {M : Type u} [TopologicalSpace M]
    (h : Nonempty (M ≃ₜ ThreeSphere)) {x y : M} (hyx : y ≠ x)
    (singleBase singleTarget : ({x}ᶜ : Set M))
    (chosenSinglePath : Path singleBase singleTarget)
...
/--
Theorem contract for
`singletonChosenPathLoop_and_twoPointFullChartEndpointDataPathCoherence_of_homeomorph_to_threeSphere`.
-/
theorem singletonChosenPathLoop_and_twoPointFullChartEndpointDataPathCoherence_of_homeomorph_to_threeSphere_eq :
    @Poincare.singletonChosenPathLoop_and_twoPointFullChartEndpointDataPathCoherence_of_homeomorph_to_threeSphere =
      @Poincare.singletonChosenPathLoop_and_twoPointFullChartEndpointDataPathCoherence_of_homeomorph_to_threeSphere :=
  rfl

/--
Recognition as `ThreeSphere` projects the singleton/two-puncture full-chart
endpoint-data path-coherence package to the chosen-path homotopy core used by
the one-point compactification route.
-/
theorem singletonChosenPathLoop_and_twoPointEndpointDataPathCoherence_core_of_homeomorph_to_threeSphere
    {M : Type u} [TopologicalSpace M]
    (h : Nonempty (M ≃ₜ ThreeSphere)) {x y : M} (hyx : y ≠ x)
    (singleBase singleTarget : ({x}ᶜ : Set M))
    (chosenSinglePath : Path singleBase singleTarget)
...
/--
Theorem contract for
`singletonChosenPathLoop_and_twoPointEndpointDataPathCoherence_core_of_homeomorph_to_threeSphere`.
-/
theorem singletonChosenPathLoop_and_twoPointEndpointDataPathCoherence_core_of_homeomorph_to_threeSphere_eq :
    @Poincare.singletonChosenPathLoop_and_twoPointEndpointDataPathCoherence_core_of_homeomorph_to_threeSphere =
      @Poincare.singletonChosenPathLoop_and_twoPointEndpointDataPathCoherence_core_of_homeomorph_to_threeSphere :=
  rfl
...
/--
Recognition as `ThreeSphere` gives the actual Euclidean chart on a singleton
complement together with explicit singleton chosen-path data and a
full-topology two-puncture chosen path/loop projection payload.
-/
theorem singletonEuclideanChart_chosenPathLoop_and_twoPointFullTopologyChosenPathLoopProjection_of_homeomorph_to_threeSphere
    {M : Type u} [TopologicalSpace M]
    (h : Nonempty (M ≃ₜ ThreeSphere)) {x y : M} (hyx : y ≠ x)
    (singleBase singleTarget : ({x}ᶜ : Set M))
    (chosenSinglePath : Path singleBase singleTarget)
...
/--
Theorem contract for
`singletonEuclideanChart_chosenPathLoop_and_twoPointFullTopologyChosenPathLoopProjection_of_homeomorph_to_threeSphere`.
-/
theorem singletonEuclideanChart_chosenPathLoop_and_twoPointFullTopologyChosenPathLoopProjection_of_homeomorph_to_threeSphere_eq :
    @Poincare.singletonEuclideanChart_chosenPathLoop_and_twoPointFullTopologyChosenPathLoopProjection_of_homeomorph_to_threeSphere =
      @Poincare.singletonEuclideanChart_chosenPathLoop_and_twoPointFullTopologyChosenPathLoopProjection_of_homeomorph_to_threeSphere :=
  rfl
...
Recognition as `ThreeSphere` gives the actual Euclidean chart on a singleton
complement together with explicit singleton chosen-path data, singleton
path/loop collapse, and the full two-puncture chart/path-loop projection
payload.
-/
theorem singletonEuclideanChart_chosenPathLoop_and_twoPointFullChartPathLoopProjection_of_homeomorph_to_threeSphere
    {M : Type u} [TopologicalSpace M]
    (h : Nonempty (M ≃ₜ ThreeSphere)) {x y : M} (hyx : y ≠ x)
    (singleBase singleTarget : ({x}ᶜ : Set M))
    (chosenSinglePath : Path singleBase singleTarget)
...
/--
Theorem contract for
`singletonEuclideanChart_chosenPathLoop_and_twoPointFullChartPathLoopProjection_of_homeomorph_to_threeSphere`.
-/
...
/--
Recognition as `ThreeSphere` supplies the singleton Euclidean chart and direct
endpoint-data path coherence together with local path-connectedness of the
two-puncture complement.
-/
theorem singletonEuclideanChart_chosenPathLoop_and_twoPointLocPathFullChartEndpointDataPathCoherence_of_homeomorph_to_threeSphere
    {M : Type u} [TopologicalSpace M]
...
/--
Theorem contract for
`singletonEuclideanChart_chosenPathLoop_and_twoPointLocPathFullChartEndpointDataPathCoherence_of_homeomorph_to_threeSphere`.
-/
theorem singletonEuclideanChart_chosenPathLoop_and_twoPointLocPathFullChartEndpointDataPathCoherence_of_homeomorph_to_threeSphere_eq :
    @Poincare.singletonEuclideanChart_chosenPathLoop_and_twoPointLocPathFullChartEndpointDataPathCoherence_of_homeomorph_to_threeSphere =
      @Poincare.singletonEuclideanChart_chosenPathLoop_and_twoPointLocPathFullChartEndpointDataPathCoherence_of_homeomorph_to_threeSphere :=
  rfl

/--
Recognition as `ThreeSphere` projects the singleton/two-puncture endpoint
loop-collapse package to the same compact homotopy core used by the one-point
compactification route.
-/
theorem singletonAndTwoPoint_endpointData_loopCollapse_core_of_homeomorph_to_threeSphere
    {M : Type u} [TopologicalSpace M]
    (h : Nonempty (M ≃ₜ ThreeSphere)) {x y : M} (hyx : y ≠ x)
    (singleBase singleTarget : ({x}ᶜ : Set M))
    (singleLoop : Path singleBase singleBase)
...
/--
Theorem contract for
`singletonAndTwoPoint_endpointData_loopCollapse_core_of_homeomorph_to_threeSphere`.
-/
