...
/--
The verification-payload derivation-and-boundary family is reconstructed from
the verification-payload scalar-pointwise surgery payload.
-/
theorem analytic_derivation_and_boundary_payload_statements_of_equation_boundary_verification_payload_to_pointwise_equation_payload_eq
    {dependencies : PoincareProofDependenciesWithEquationBoundary.{u}}
    (payload : EquationBoundaryVerificationPayload dependencies) :
    analytic_derivation_and_boundary_payload_statements_of_equation_boundary_verification_payload
        payload =
...
the verification-payload direct stored-verification scalar equation payload.
-/
theorem analytic_derivation_and_boundary_payload_statements_of_equation_boundary_verification_payload_to_direct_pointwise_equation_payload_eq
    {dependencies : PoincareProofDependenciesWithEquationBoundary.{u}}
    (payload : EquationBoundaryVerificationPayload dependencies) :
    analytic_derivation_and_boundary_payload_statements_of_equation_boundary_verification_payload
        payload =
...
/--
The verification-payload analytic derivation family is reconstructed from the
verification-payload scalar-pointwise surgery payload.
-/
theorem analytic_derivation_statements_of_equation_boundary_verification_payload_to_pointwise_equation_payload_eq
    {dependencies : PoincareProofDependenciesWithEquationBoundary.{u}}
    (payload : EquationBoundaryVerificationPayload dependencies) :
    analytic_derivation_statements_of_equation_boundary_verification_payload
        payload =
...
verification-payload direct stored-verification scalar equation payload.
-/
theorem analytic_derivation_statements_of_equation_boundary_verification_payload_to_direct_pointwise_equation_payload_eq
    {dependencies : PoincareProofDependenciesWithEquationBoundary.{u}}
    (payload : EquationBoundaryVerificationPayload dependencies) :
    analytic_derivation_statements_of_equation_boundary_verification_payload
        payload =
...
/--
The named dependency derivation-and-boundary family is reconstructed from the
named dependency scalar-pointwise surgery payload.
-/
theorem analytic_derivation_and_boundary_payload_statements_of_dependencies_to_pointwise_equation_payload_eq
    (dependencies : PoincareProofDependenciesWithEquationBoundary.{u}) :
    analytic_derivation_and_boundary_payload_statements_of_dependencies
        dependencies =
      (by
...
/--
The named dependency derivation-and-boundary family is reconstructed from the
named dependency direct stored-verification scalar equation payload.
-/
theorem analytic_derivation_and_boundary_payload_statements_of_dependencies_to_direct_pointwise_equation_payload_eq
    (dependencies : PoincareProofDependenciesWithEquationBoundary.{u}) :
    analytic_derivation_and_boundary_payload_statements_of_dependencies
        dependencies =
      (by
...
/--
The strengthened dependency analytic derivation family is reconstructed from
the named dependency scalar-pointwise surgery payload.
-/
theorem analytic_derivation_statements_of_dependencies_to_pointwise_equation_payload_eq
    (dependencies : PoincareProofDependenciesWithEquationBoundary.{u}) :
    analytic_derivation_statements_of_dependencies dependencies =
      (by
        intro M _ _ _ _ _ _
...
/--
The strengthened dependency analytic derivation family is reconstructed from
the named dependency direct stored-verification scalar equation payload.
-/
theorem analytic_derivation_statements_of_dependencies_to_direct_pointwise_equation_payload_eq
    (dependencies : PoincareProofDependenciesWithEquationBoundary.{u}) :
    analytic_derivation_statements_of_dependencies dependencies =
      (by
        intro M _ _ _ _ _ _
...
-/
theorem topology_derivation_statement_via_extraction_of_dependencies_to_package_eq
    (dependencies : PoincareProofDependencies.{u})
    (M : Type u) [TopologicalSpace M] [T2Space M]
    [ChartedSpace (EuclideanSpace ℝ (Fin 3)) M]
    [SimplyConnectedSpace M] [CompactSpace M]
...
extraction payload also follows the stored topology-package route.
-/
theorem topology_homeomorphism_assembly_statement_via_extraction_of_dependencies_to_package_eq
    (dependencies : PoincareProofDependencies.{u})
    (M : Type u) [TopologicalSpace M] [T2Space M]
    [ChartedSpace (EuclideanSpace ℝ (Fin 3)) M]
    [SimplyConnectedSpace M] [CompactSpace M]
...
/--
The dependency-level simply-connected recognition statement selected through
the extraction payload also follows the stored topology-package route.
-/
theorem topology_simply_connected_recognition_statement_via_extraction_of_dependencies_to_package_eq
    (dependencies : PoincareProofDependencies.{u})
    (M : Type u) [TopologicalSpace M] [T2Space M]
    [ChartedSpace (EuclideanSpace ℝ (Fin 3)) M]
    [SimplyConnectedSpace M] [CompactSpace M]
...
extraction payload also follows the stored topology-package route.
-/
theorem topology_spherical_trivial_quotient_statement_via_extraction_of_dependencies_to_package_eq
    (dependencies : PoincareProofDependencies.{u})
    (M : Type u) [TopologicalSpace M] [T2Space M]
    [ChartedSpace (EuclideanSpace ℝ (Fin 3)) M]
    [SimplyConnectedSpace M] [CompactSpace M]
...
the extraction payload also follows the stored topology-package route.
-/
theorem topology_spherical_homeomorphism_lift_statement_via_extraction_of_dependencies_to_package_eq
    (dependencies : PoincareProofDependencies.{u})
    (M : Type u) [TopologicalSpace M] [T2Space M]
    [ChartedSpace (EuclideanSpace ℝ (Fin 3)) M]
    [SimplyConnectedSpace M] [CompactSpace M]
...
extraction payload also follows the stored topology-package route.
-/
theorem topology_homeomorphism_derivation_statement_via_extraction_of_dependencies_to_package_eq
    (dependencies : PoincareProofDependencies.{u})
    (M : Type u) [TopologicalSpace M] [T2Space M]
    [ChartedSpace (EuclideanSpace ℝ (Fin 3)) M]
    [SimplyConnectedSpace M] [CompactSpace M]
...
/--
The strengthened dependency final extractor also follows the stored
topology-package route after forgetting equation-boundary data.
-/
theorem extinction_extraction_of_equation_boundary_dependencies_to_package_eq
    (dependencies : PoincareProofDependenciesWithEquationBoundary.{u}) :
    extinction_extraction_of_equation_boundary_dependencies dependencies =
      extinction_implies_sphere_of_topology_package
...
-/
theorem topology_extraction_lifted_homeomorphism_derivation_payload_of_equation_boundary_dependencies_to_package_eq
    (dependencies : PoincareProofDependenciesWithEquationBoundary.{u}) :
    topology_extraction_lifted_homeomorphism_derivation_payload_of_equation_boundary_dependencies
        dependencies =
      topology_extraction_lifted_homeomorphism_derivation_payload_of_topology_package
...
stored topology-package route after forgetting equation-boundary data.
-/
theorem topology_simply_connected_recognition_statement_of_equation_boundary_dependencies_to_package_eq
    (dependencies : PoincareProofDependenciesWithEquationBoundary.{u})
    (M : Type u) [TopologicalSpace M] [T2Space M]
    [ChartedSpace (EuclideanSpace ℝ (Fin 3)) M]
    [SimplyConnectedSpace M] [CompactSpace M]
...
topology-package route after forgetting equation-boundary data.
-/
theorem topology_spherical_trivial_quotient_statement_of_equation_boundary_dependencies_to_package_eq
    (dependencies : PoincareProofDependenciesWithEquationBoundary.{u})
    (M : Type u) [TopologicalSpace M] [T2Space M]
    [ChartedSpace (EuclideanSpace ℝ (Fin 3)) M]
    [SimplyConnectedSpace M] [CompactSpace M]
...
stored topology-package route after forgetting equation-boundary data.
-/
theorem topology_spherical_homeomorphism_lift_statement_of_equation_boundary_dependencies_to_package_eq
    (dependencies : PoincareProofDependenciesWithEquationBoundary.{u})
    (M : Type u) [TopologicalSpace M] [T2Space M]
    [ChartedSpace (EuclideanSpace ℝ (Fin 3)) M]
    [SimplyConnectedSpace M] [CompactSpace M]
...
stored topology-package route after forgetting equation-boundary data.
-/
theorem topology_lifted_homeomorphism_derivation_statement_of_equation_boundary_dependencies_to_package_eq
    (dependencies : PoincareProofDependenciesWithEquationBoundary.{u})
    (M : Type u) [TopologicalSpace M] [T2Space M]
    [ChartedSpace (EuclideanSpace ℝ (Fin 3)) M]
    [SimplyConnectedSpace M] [CompactSpace M]
...
/--
The dependency projection completion payload can also be exposed directly as
the verification payload selected by its own existential witness.
-/
theorem poincare_completion_payload_of_dependency_projections_to_direct_verification_payload_eq
    (dependencies : PoincareProofDependencies.{u}) :
    let payload :=
      poincare_completion_payload_of_dependency_projections dependencies
    poincare_completion_payload_of_dependency_projections dependencies =
...
/--
The certified dependency projection completion payload can also be exposed
directly as the verification payload selected by its own existential witness.
-/
theorem poincare_completion_payload_of_extraction_derivation_dependency_projections_to_direct_verification_payload_eq
    (dependencies : PoincareProofDependencies.{u}) :
    let payload :=
      poincare_completion_payload_of_extraction_derivation_dependency_projections
        dependencies
...
/--
The lifted-homeomorphism dependency projection completion payload can also be
exposed directly as the verification payload selected by its own existential
witness.
-/
theorem poincare_completion_payload_of_lifted_homeomorphism_derivation_dependency_projections_to_direct_verification_payload_eq
    (dependencies : PoincareProofDependencies.{u}) :
    let payload :=
      poincare_completion_payload_of_lifted_homeomorphism_derivation_dependency_projections
        dependencies
...
/--
The strengthened dependency projection completion payload can also be exposed
directly as the verification payload selected by its own existential witness.
-/
theorem poincare_completion_payload_of_equation_boundary_dependency_projections_to_direct_verification_payload_eq
    (dependencies : PoincareProofDependenciesWithEquationBoundary.{u}) :
    let payload :=
      poincare_completion_payload_of_equation_boundary_dependency_projections
        dependencies
...
/--
The strengthened certified projection completion payload can also be exposed
directly as the verification payload selected by its own existential witness.
-/
theorem poincare_completion_payload_of_equation_boundary_extraction_derivation_dependency_projections_to_direct_verification_payload_eq
    (dependencies : PoincareProofDependenciesWithEquationBoundary.{u}) :
    let payload :=
      poincare_completion_payload_of_equation_boundary_extraction_derivation_dependency_projections
        dependencies
...
/--
The strengthened lifted-homeomorphism projection completion payload can also
be exposed directly as the verification payload selected by its own
existential witness.
-/
theorem poincare_completion_payload_of_equation_boundary_lifted_homeomorphism_derivation_dependency_projections_to_direct_verification_payload_eq
    (dependencies : PoincareProofDependenciesWithEquationBoundary.{u}) :
    let payload :=
      poincare_completion_payload_of_equation_boundary_lifted_homeomorphism_derivation_dependency_projections
        dependencies
